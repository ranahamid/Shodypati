...
namespace Shodypati.DAL
{
    ...
    public class CampaignProductDataAccessRepository : BaseController,
        ICampaignProductAccessRepository<CampaignProducts, int>
    {
        ...
        public void Put(CampaignProducts entity)
        {
            ...
            foreach (var detail in query) Db.CampaignProductsTbls.DeleteOnSubmit(detail);
            ...
            var selectedProduct = entity.AllProductsSelectListStr;
        ...
        public List<string> GetAllCampaignProductsList()
        {
            ...
            foreach (var item in items) entities.Add(item.ProductId.ToString());
            return entities;
        }
