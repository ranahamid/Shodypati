        ...
        _.extend(Animator.prototype,
            Backbone.Events,
            {
                activate: function() {
                    ...
                    TweenMax.to(this.$button,
                        this.animation.button.DurationIN,
                        _.extend({},
                            this.animation.button.TransitionIN,
                            {
                ...
                show: function() {
                    ...
                    TweenMax.to(this.$panel,
                        this.animation.panel.DurationIN,
                        _.extend({},
                            this.animation.panel.TransitionIN,
                            {
        ...
        var PanelView = Backbone.View.extend(
            {
                ...
                initialize: function() {
                    ...
                    this.wishSection =
                        this.iswish
                        ? new SectionView({ el: ".cp-section-wish", list: this.wishList, panel: this })
                        : null;
                ...
                change: function(section) {
                    ...
                    this.$checkoutButton.toggleClass("hidden",
        ...
        _.extend(PanelView.prototype,
            {
                ...
                render: function() {
                    ...
                    this.$headerTotalWishLabel &&
                        this.$headerTotalWishLabel.html(wishListStats ? wishListStats.totalItems : 0);
...
/***/ function(module, exports) {
        ...
        module.exports = {
            ...
            format: function(price, currency) {
                ...
                return p.before +
                    "" +
                    number.toFixed(Math.max(0, ~~p.n)).replace(new RegExp(r, "g"), "$&" + p.divider) +
                    "" +
                    p.after;
            }
        ...
        var SectionView = Backbone.View.extend(
            {
                ...
                activate: function() {
                    ...
                    setTimeout(_.bind(function() {
                                ...
                                TweenMax.staggerTo(someClassName,
                                    0.3,
                ...
                setEmpty: function() {
                    ...
                    if (this.list.getStats().totalItems < 1) {
                        $("." + this.el.className + " .cp-section-wrapper").append(EmptyHTML({
                            message: "Your " +
                                (this.el.className == "cp-section-cart" ? "shopping cart" : "wish list") +
                                " is empty."
                        }));
                    }
        ...
        module.exports = function(obj) {
            ...
            with (obj) {
                ...
                if (totalCart > 0 || totalWish > 0) {
                    ...
                    print(totalWish > 0 && totalCart > 0
                        ? " cb-state_both"
                        : (totalCart > 0 ? " cb-state_cart" : " cb-state_wish"));
                    __p +=
