...
(function() {
    ...
    Chart.Arc = Chart.Element.extend({
        inRange: function(chartX, chartY) {
            ...
            var betweenAngles = (pointRelativePosition.angle >= this.startAngle &&
                    pointRelativePosition.angle <= this.endAngle),
                withinRadius = (pointRelativePosition.distance >= this.innerRadius &&
    ...
    Chart.Rectangle = Chart.Element.extend({
        ...
        inRange: function(chartX, chartY) {
            return (chartX >= this.x - this.width / 2 && chartX <= this.x + this.width / 2) &&
    ...
    Chart.RadialScale = Chart.Element.extend({
        initialize: function() {
            ...
            this.drawingArea =
                (this.display) ? (this.size / 2) - (this.fontSize / 2 + this.backdropPaddingY) : (this.size / 2);
        },
...
(function() {
    ...
    Chart.Type.extend({
        ...
        initialize: function(data) {
            ...
            this.segments = [];
            this.outerRadius =
                (helpers.min([this.chart.width, this.chart.height]) - this.options.segmentStrokeWidth / 2) / 2;
            ...
            if (this.options.showTooltips) {
                helpers.bindEvents(this,
                    ...
                    function(evt) {
                        ...
                        helpers.each(this.segments,
                            function(segment) {
                                segment.restore(["fillColor"]);
                            });
                        helpers.each(activeSegments,
            ...
            if (this.options.showTooltips) {
                helpers.bindEvents(this,
                    ...
                    function(evt) {
                        ...
                        helpers.each(activePointsCollection,
                            function(activePoint) {
                                activePoint.fillColor = activePoint.highlightFill;
                                activePoint.strokeColor = activePoint.highlightStroke;
                            });
