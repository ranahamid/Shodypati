...
*/
    ...
    var CellDragListener = DragListener.extend({
        ...
        dragStart: function(ev) {
            ...
            cell =
                this.getCell(ev.pageX, ev.pageY); // might be different from this.origCell if the min-distance is large
...
----------------------------------------------------------------------------------------------------------------------*/
    ...
    var Grid = fc.Grid = RowRenderer.extend({
        ...
        fabricateHelperEvent: function(range, sourceSeg) {
            var fakeEvent =
                sourceSeg ? createObject(sourceSeg.event) : {}; // mask the original event object if possible
            ...
            var dragListener = new CellDragListener(view.coordMap,
                {
                    ...
                    dragStart: function(ev) {
                        _this.triggerSegMouseout(seg,
                            ev); // ensure a mouseout on the manipulated event has been reported
    ...
    var TimeGrid = Grid.extend({
        ...
        renderFill: function(type, segs, className) {
            ...
            if (segs.length) {
                ...
                segs =
                    this.renderFillSegEls(type, segs); // assignes `.el` to each seg. returns successfully rendered segs
            ...
            if (currentView) {
                ...
                if (
                    !currentView.displaying ||
                        !date.isWithin(currentView.intervalStart,
                    ...
                    function(i) {
                        ...
                        $.each(this.split(","),
                            function(j, buttonName) {
                                ...
                                if (buttonName == "title") {
                                    groupChildren =
                                        groupChildren.add($("<h2>&nbsp;</h2>")); // we always want it to take up height
                                    isOnlyButtons = false;
                                } else {
                                    if ((customButtonProps = (calendar.options.customButtons || {})[buttonName])) {
                                        ...
                                        defaultText =
                                            options.buttonText[buttonName]; // everything else is considered default
                                    }
                ...
                if (abstractEvent._recurring) {
                    ...
                    while (date.isBefore(_rangeEnd)) {
                        ...
                        if (!dowHash || dowHash[date.day()]) { // if everyday, or this particular day-of-week
                            ...
                            startTime =
                                abstractEvent.start; // the stored start and end properties are times (Durations)
...
// It is responsible for managing width/height.
    ...
    var BasicView = View.extend({
        ...
        renderDates: function() {
            ...
            this.dayGrid.coordMap.containerEl =
                this.scrollerEl; // constrain clicks/etc to the dimensions of the scroller
    ...
    var MonthView = BasicView.extend({
        ...
        computeRange: function(date) {
            ...
            if (this.isFixedWeeks()) {
                rowCnt =
                    Math.ceil(range.end.diff(range.start, "weeks", true)); // could be partial weeks due to hiddenDays
