                    ...
                    if (false === response) {
                        ...
                        case "json":
                            ...
                            if (false === holder[providerKey]) {
                                callFunction(options.error, options, chart);
                                raiseError(AmCharts.__("Error parsing JSON file", chart.language) + ": " + l.url,
                                    false,
                                    options);
                                holder[providerKey] = [];
                                return;
                        ...
                        case "csv":
                            ...
                            if (false === holder[providerKey]) {
                                callFunction(options.error, options, chart);
                                raiseError(AmCharts.__("Error parsing CSV file", chart.language) + ": " + l.url,
                                    false,
                                    options);
                                holder[providerKey] = [];
                                return;
                        ...
                        default:
                            callFunction(options.error, options, chart);
                            raiseError(AmCharts.__("Unsupported data format", chart.language) + ": " + options.format,
                                false,
                                options.noStyles);
                            return;
                        }
...
if (undefined === AmCharts.__) {
    AmCharts.__ = function(msg, language) {
        if (undefined !== language &&
            undefined !== AmCharts.translations.dataLoader[language] &&
            undefined !== AmCharts.translations.dataLoader[language][msg])
