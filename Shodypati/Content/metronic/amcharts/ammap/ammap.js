    ...
    d.wordwrap = function(a, b, c, e) {
        ...
        for (a = (k = a.split(/\r\n|\n|\r/)).length;
            ...
            for (k[g] = ""; h.length > b; k[g] += d.trim(h.slice(0, f)) + ((h = h.slice(f)).length ? c : ""))
                f = 2 == e || (f = h.slice(0, b + 1).match(/\S*(\s)?$/))[1]
                    ? b
    ...
    d.formatDuration = function(a, b, c, e, g, f) {
        ...
        if (h[g].count > h[b].count)
            for (a = h[b].count; a < h[g].count; a++)
                b = h[b].nextInterval, "ss" == b || "mm" == b || "hh" == b
                    ? c = "00" + e[b] + "" + c
                    : "DD" == b && (c = "0" + e[b] + "" + c);
    ...
    d.formatValue = function(a, b, c, e, g, f, h, k) {
        if (b) {
            ...
            for (l = 0; l < c.length; l++) {
                var m = c[l], n = b[m];
                void 0 !== n &&
                (n = f ? d.addPrefix(n, k, h, e) : d.formatNumber(n, e), a =
                    a.replace(new RegExp("\\[\\[" + g + "" + m + "\\]\\]", "g"), n))
            }
        }
        return a
    };
        ...
        for (var c in a) {
            ...
            if (0 < a[c].length && "object" == e)
                for (var g =
                        0;
                    g < a[c].length;
                    g++) e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c][g], e);
            else
                "object" == e
...
(function() {
    ...
    d.AmDraw = d.Class({
        ...
        rect: function(a, b, c, e, g, f, h) {
            ...
            d.VML &&
            (g = Math.round(100 * g / Math.min(c, e)), c += 2 * f, e += 2 * f, k.bw = f, k.node.style.marginLeft =
    ...
    d.SVGRenderer = d.Class({
        ...
        update: function() {
            ...
            for (a = b.length - 1; 0 <= a; a--) {
                ...
                g <= e
                    ? (c.frame++, "translate" == h
                            ? (k = c.from.split(","), h = Number(k[0]), k = Number(k[1]), isNaN(k) && (k = 0), l =
                                c.to.split(","), m = Number(l[0]), l = Number(l[1]), m = 0 === m - h
                                ? m
                                : Math.round(d[c.effect](0,
                                    g,
                                    h,
                                    m - h,
                                    e)), c = 0 === l - k ? l : Math.round(d[c.effect](0, g, k, l - k, e)), h =
                                "transform", c = "translate(" + m + "," + c + ")")
                            : (l = Number(c.from), k = Number(c.to), m = k - l, c =
                                d[c.effect](0, g, l, m, e), isNaN(c) && (c = k), 0 === m && this.animations.splice(a, 1)
                            ),
                        this.setAttr(f, h, c))
                    : ("translate" == h
                        ? (l = c.to.split(","), m = Number(l[0]), l = Number(l[1]), f.translate(m, l))
                        : (k = Number(c.to), this.setAttr(f, h, k)), this.animations.splice(a, 1))
            }
        },
        getBBox: function(a) {
            if (a = a.node)
        ...
        clipRect: function(a, b, c, e, g) {
            ...
            var k = f.parentNode;
            k &&
            (f = document.createElementNS(d.SVG_NS, "clipPath"), h =
                d.getUniqueId(), f.setAttribute("id", h), this.D.rect(b, c, e, g, 0, 0, f), k.appendChild(f), b =
                "#", d.baseHref && !d.isIE && (b = this.removeTarget(window.location.href) + b), this.setAttr(a,
                "clip-path",
                "url(" + b + h + ")"), this.clipPathC++, a.clipPath = f)
        },
        text: function(a, b, c) {
        ...
        gradient: function(a, b, c, e) {
            ...
            for (e = 0; e < c.length; e++)
                h = document.createElementNS(d.SVG_NS, "stop"), k =
                    100 * e / (c.length - 1), 0 === e && (k = 0), h.setAttribute("offset", k + "%"), h.setAttribute(
                    "stop-color",
                    c[e]), b.appendChild(h);
    ...
    d.AmChart = d.Class({
        ...
        drawBackground: function() {
            ...
            if (b = this.backgroundImage)
                a = a.image(b, 0, 0, g, f), d.setCN(this, b, "bg-image"), this.bgImg =
                    a, e.push(a)
        },
            ...
            if (a) {
                ...
                (c != this.previousWidth || e != this.previousHeight) &&
                    ...
                    (b.style.width = a + "px", b.style.height = f + "px", b.style.padding =
                        0, g && g.setSize(a, f), this.balloon =
            ...
            if (this.animations)
                for (a = this.animations.length - 1; 0 <= a; a--) {
                    ...
                    if (e <= c) {
                        ...
                        0 === k
                            ? (this.animations.splice(a, 1), g.node.style[f] = Number(b.to) + b.suffix)
        ...
        brr: function() {
            ...
            if (c != a || !0 === this.inIframe()) {
                ...
                "ammap" == this.product &&
                (h = a + "/javascript-maps/", k = "Interactive JavaScript maps",
        ...
        draw: function() {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    "H" != C
                        ? (u = a - v / 2, b < k + w + 10 && "down" != C
                            ? (F = !0, e && (b += x), x = b + z, this.deltaSignY = -1)
                            : (e && (b -= x), x = b - w - z, this.deltaSignY = 1))
                        : (2 * z > w && (z = w / 2), x = b - w / 2, a < h + (l - h) / 2
                            ? (u = a + z, this.deltaSignX = -1)
                            : (u = a - v - z, this.deltaSignX = 1));
                    x + w >= m && (x = m - w);
                    x < k && (x = k);
                    u < h && (u = h);
                    u + v > l && (u = l - v);
                    ...
                    0 < A || 0 === z
                        ? (0 < y &&
                            (a = d.rect(g,
                                ...
                                E,
                                y,
                                this.cornerRadius), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), r =
                                d.rect(g, v, w, r, this.fillAlpha, q, t, this.borderAlpha, this.cornerRadius),
                            this.showBullet && (B = d.circle(g, G, p, this.fillAlpha), f.push(B)))
                        : (p = [], A = [], "H" != C
                            ? (h = a - u, h > v - z && (h = v - z), h < z && (h = z), p =
                                [0, h - z, a - u, h + z, v, v, 0, 0], A =
                                F ? [0, 0, b - x, 0, 0, w, w, 0] : [w, w, b - x, w, w, 0, 0, w])
                            : (p = b - x, p > w - z && (p = w - z), p < z && (p = z), A =
                                [0, p - z, b - x, p + z, w, w, 0, 0], p = a < h + (l - h) / 2
                                ? [0, 0, u < a ? 0 : a - u, 0, 0, v, v, 0]
                                : [v, v, u + v > a ? v : a - u, v, v, 0, 0, v]), 0 < y &&
                        (a = d.polygon(g,
                            p,
                            A,
                            r,
                            ...
                            q,
                            E,
                            y), a.translate(1, 1), f.push(a)), r =
                            d.polygon(g, p, A, r, this.fillAlpha, q, t, this.borderAlpha));
                    this.bg = r;
                    f.push(r);
                    r.toFront();
                    ...
                    0 < this.animationDuration &&
                        ...
                        (f.translate(this.prevX, this.prevY), f.animate({
                            ...
                            b,
                            "easeOutSine"), n &&
                        (D.left = this.prevTX + "px", D.top = this.prevTY + "px", this.xAnim =
...
(function() {
    ...
    d.bullet = function(a, b, c, e, g, f, h, k, l, m, n, r) {
        ...
        case "yError":
            ...
            break;
        case "xError":
            t = a.set(), t.push(d.line(a, [-c / 2, c / 2], [0, 0], e, g, f)), t.push(d.line(a,
                [-c / 2, -c / 2],
                [-l, l],
                e,
                g,
                f)), t.push(d.line(a, [c / 2, c / 2], [-l, l], e, g, f))
        }
        t && t.pattern(n, NaN, r);
        return t
    };
    ...
    d.makeHD = function(a, b, c) {
        for (var e = [], d = [], f = 1; f < a.length; f++)
            for (var h = Number(a[f - 1]),
                k = Number(b[f - 1]),
                l = Number(a[f]),
                m = Number(b[f]),
                n = Math.sqrt(Math.pow(l - h, 2) + Math.pow(m - k, 2)),
                n = Math.round(n / 50) + 1,
                l = (l - h) / n,
                m = (m - k) / n,
                r = 0;
    ...
    d.handDrawnLine = function(a, b, c, e, g, f, h, k, l, m) {
        ...
        for (n = 1; n < b.length; n++)
            for (var t = [b[n - 1], b[n]],
                p = [c[n - 1], c[n]],
                p = d.makeHD(t, p, a.handDrawScatter),
                t = p[0],
                p = p[1],
                q = 1;
                q < t.length;
    ...
    d.wedge = function(a, b, c, e, g, f, h, k, l, m, n, r, t) {
        ...
        var C = 1 / 180 * Math.PI,
            ...
            w = b + Math.sin(e * C) * f,
            x = c - Math.cos(e * C) * h,
            D = b + Math.sin((e + g) * C) * f,
            u = c - Math.cos((e + g) * C) * h,
            v = b + Math.sin((e + g) * C) * k,
            C = c - Math.cos((e + g) * C) * q,
        ...
        var G;
        y &&
        (z = p(10 * z), w = p(10 * w), D = p(10 * D), v = p(10 * v), A = p(10 * A), x = p(10 * x), u = p(10 * u), C =
            p(10 * C), b = p(10 * b), l = p(10 * l), c =
            p(10 * c), f *= 10, h *= 10, k *= 10, q *= 10, 1 > Math.abs(g) &&
            1 >=
            Math.abs(D -
                w) &&
            1 >= Math.abs(u - x) &&
        ...
        if (0 < l) {
            ...
            y
                ...
                (B += " B" +
                    ...
                    "," +
                    (l + A))))
                : (B += " A" + f + "," + h + ",0," + E + ",1," + D + "," + (u + l) + " L" + v + "," + (C + l), 0 < k &&
                    (B += " A" + k + "," + q + ",0," + E + ",0," + z + "," + (A + l)));
            B += " Z";
            var I = l;
            y &&
    ...
    d.adjustLuminosity = function(a, b) {
        ...
        var c = "#", e, g;
        for (g = 0; 3 > g; g++)
            e = parseInt(a.substr(2 * g, 2), 16), e =
...
(function() {
    ...
    d.AmLegend = d.Class({
        ...
        drawLegend: function() {
            ...
            this.titleWidth = 0;
            if (g = this.title)
                g = d.text(this.container, g, this.color, a.fontFamily, this.fontSize, "start", !0), d.setCN(a,
                    g,
                    "legend-title"), g.translate(this.marginLeft, this.marginTop + this.verticalGap + this.ly + 1), a =
                    g.getBBox(), this.titleWidth = a.width + 15, this.titleHeight = a.height + 6;
        ...
        arrangeEntries: function() {
            ...
            l = A.height + 2 * m - 1;
            "left" == a || "right" == a
                ? (n = A.width + 2 * f, k = n + b + c, h.style.width = k + "px", this.ieW = k)
                : n = k - b - c - 1;
            ...
            if ("top" == a ||
                ...
                a ||
                "outside" == a)
                "center" == this.align ? b = f + (n - A.width) / 2 : "right" == this.align && (b = f + n - A.width);
            z.translate(b, m + 1);
            ...
            if (!1 !== a.visibleInLegend) {
                ...
                if (this.useGraphSettings) {
                    ...
                    if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c)
                        h = l.set(), a.hidden || (e = a.lineColorR, f = a.bulletBorderColorR), n =
                                d.line(l, [0, 2 * m], [m / 2, m / 2], e, a.lineAlpha, a.lineThickness, a.dashLength),
                            d.setCN(b, n, "graph-stroke"), h.push(n), a.bullet &&
                                (a.hidden || (e = a.bulletColorR),
                                    n = d.bullet(l,
                                        ...
                                        f,
                                        a.bulletBorderAlpha)) &&
                                (d.setCN(b, n, "graph-bullet"), n.translate(m + 1, m / 2), h.push(n)), t = 0, n = m, r =
                                m / 3;
                    else {
                        var p;
                        ...
                        !0 === a.hidden && (n = e);
                        if (h =
                            this.createMarker("rectangle", n, a.fillAlphas, a.lineThickness, e, a.lineAlpha, p, h))
                            t = m, h.translate(t, m / 2);
                        n = m
                    }
                    d.setCN(b, h, "graph-" + c);
                    d.setCN(b, h, "graph-" + a.id)
                } else if (k) h = l.image(k, 0, 0, m, m);
                else {
                    var q;
                ...
                (f = this.switchType) &&
                    "none" != f &&
                    0 < m &&
                    ("x" == f ? (p = this.createX(), p.translate(m / 2, m / 2)) : p = this.createV(), p.dItem =
                            a, !0 !== a.hidden ? "x" == f ? p.hide() : p.show() : "x" != f && p.hide(),
                        this.switchable ||
                            p.hide(),
                ...
                p = this.fontSize;
                h &&
                (m <= p && h.translate(t, m / 2 + this.ly - p / 2 + (p + 2 - m) / 2 - r), a.legendEntryWidth =
                    h.getBBox().width);
                var y;
                e &&
                (e = d.fixBrakes(e), a.legendTextReal = e, y = this.labelWidth, y = isNaN(y)
                        ? d.text(this.container,
                            ...
                            p,
                            "start")
                        : d.wrappedText(this.container, e, f, b.fontFamily, p, "start", !1, y, 0),
                    d.setCN(b, y, "legend-label"), y.translate(this.lx + n, this.ly), l.push(y), b =
                        y.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b));
            ...
            for (c = 0; c < a.length; c++) {
                ...
                if (e) f.value ? g.text(f.value) : g.text("");
                    ...
                    if (void 0 !== f.type) {
                        ...
                        k
                            ? (h = this.valueText, f.legendValueText && (h = f.legendValueText), h =
                                b.formatString(h, k))
                            : l &&
                            b.formatPeriodString &&
                            (l = d.massReplace(l, { "[[title]]": f.title }), h = b.formatPeriodString(l, f))
...
(function() {
    ...
    d.AmMap = d.Class({
        ...
        update: function() {
            d.hasSVG &&
            (d.AmMap.base.update.call(this), this.zoomControl &&
        ...
        animateMap: function() {
            ...
            a.tweenPercent = 0;
            a.balloon.hide(0);
            setTimeout(function() { a.updateSize.call(a) }, d.updateRate)
        },
        updateSize: function() {
            ...
            a.frame <= b
                ? (a.frame++, b =
                    d.easeOutSine(0, a.frame, 0, 1, b), 1 <= b
                    ? (b = 1, a.preventHover = !1, a.wheelBusy = !1)
                    : setTimeout(function() { a.updateSize.call(a) }, d.updateRate), .8 < b && (a.preventHover = !1))
                : (b = 1, a.preventHover = !1, a.wheelBusy = !1);
            a.tweenPercent = b;
        ...
        rescaleMapAndObjects: function() {
            ...
            if (this.areasSettings.adjustOutlineThickness) {
                for (var b = this.svgAreas, d = 0; d < b.length; d++)
                    (c = b[d]) && c.setAttr("stroke-width", this.areasSettings.outlineThickness / a);
        ...
        handleMouseDown: function(a) {
            ...
            if (this.chartCreated &&
                ...
                e &&
                    ...
                    this.boundingRect &&
                    (a = e.clientX - this.boundingRect.left, e = e.clientY - this.boundingRect.top, this.middleXP =
                        (b + (a - b) / 2) / this.realWidth, this.middleYP =
                        (c + (e - c) / 2) / this.realHeight, this.initialDistance =
        ...
        handleReleaseOutside: function() {
            if (d.isModern) {
                ...
                if (!a.preventHover) {
                    ...
                    isNaN(c) ||
                        isNaN(e) ||
                        !(2 < Math.abs(b.x - c) || Math.abs(b.y - e)) ||
                        (a.mapWasDragged = !0, b = {
                            type: "dragCompleted",
                            zoomX: a.zoomX(),
                            zoomY: a.zoomY(),
                    ...
                    if (!isNaN(k)) {
                        ...
                        if (!isNaN(q)) {
                            var k = b.initialTouchZoom *
                                ...
                                l = (b.zoomY() - l * p) * (k / h) + l * p;
                            .1 < Math.abs(k - h) &&
                                (b.zoomTo(k, q, l, !0), b.mapWasPinched = !0, clearTimeout(b.pinchTO))
                        }
                    }
                    k = a.scale;
                    b.isDragging &&
                    (b.balloon.hide(0), b.positionChanged(), c = a.x + (g - c), e =
                        a.y + (f - e), b.preventDragOut &&
                    (t = -t * k + m / 2, m /= 2, c = d.fitToBounds(c, -r * k + n / 2, n / 2), e =
                        d.fitToBounds(e, t, m)), a.translate(c, e, k, !0), b.updateSmallMap());
                    b.previuosMouseX = g;
                    b.previuosMouseY =
                        f
                }
        ...
        selectObject: function(a, b) {
            ...
            a.useTargetsZoomValues &&
                e &&
                (a.zoomX = e.zoomX, a.zoomY = e.zoomY, a.zoomLatitude = e.zoomLatitude, a.zoomLongitude =
                    e.zoomLongitude, a.zoomLevel = e.zoomLevel);
            var g = c.selectedObject;
            g && c.returnInitialColor(g);
            c.selectedObject = a;
            var f = !1, h, k;
            "MapArea" == a.objectType &&
            (a.autoZoomReal && (f = !0), h = c.areasSettings.selectedOutlineColor, k =
                c.areasSettings.selectedOutlineThickness);
            if (e &&
                !f &&
                ("string" == typeof e && (e = c.getObjectById(e)), isNaN(a.zoomLevel) &&
                    isNaN(a.zoomX) &&
                    isNaN(a.zoomY))) {
            ...
            !f && isNaN(a.zoomLevel) && isNaN(a.zoomX) && isNaN(a.zoomY)
                ...
                : (c.selectedObjectTimeOut = setTimeout(function() { c.showDescriptionAndGetUrl.call(c) },
                    1E3 * e + 200), c.showObjectsAfterZoom)
                ? b || (c.processObjectsTimeOut = setTimeout(function() { c.processObjects.call(c) }, 1E3 * e + 200))
                : b || c.processObjects();
            e = a.displayObject;
            f = a.selectedColorReal;
            "MapImage" == a.objectType &&
                (h = c.imagesSettings.selectedOutlineColor, k = c.imagesSettings.selectedOutlineThickness, e = a.image);
            if (e) {
                if (d.setCN(c, e, "selected-object"), a.bringForwardOnHover && e.toFront(), !a
        ...
        returnInitialColorReal: function(a) {
            ...
            if (b) {
                ...
                if (a.showAsSelected) {
                    ...
                    "MapImage" == a.objectType &&
                    (k = this.imagesSettings.selectedOutlineColor, l =
                        this.imagesSettings.selectedOutlineThickness);
                    "MapArea" == a.objectType &&
                        (k = this.areasSettings.selectedOutlineColor, l = this.areasSettings.selectedOutlineThickness);
                    void 0 !== k && (h = k);
                    void 0 !== l && (f = l)
                }
                "bubble" == a.type &&
                ...
                if (k = a.image)
                    k.setAttr("fill", c), k.setAttr("stroke", h), k.setAttr("stroke-width", f),
                        k.setAttr("fill-opacity", e), k.setAttr("stroke-opacity", d);
                "MapArea" == a.objectType &&
                (c = 1, this.areasSettings.adjustOutlineThickness && (c = this.zoomLevel()), b.setAttr("stroke", h),
                    b.setAttr("stroke-width", f / c), b.setAttr("fill-opacity", e), b.setAttr("stroke-opacity", d));
        ...
        zoomToObject: function(a) {
            if (a) {
                ...
                "MapArea" == a.objectType &&
                (f = a.displayObject.getBBox(), b = this.mapScale, c = f.x * b, e = f.y * b, g = f.width * b, f =
                    f.height * b, k =
                    a.autoZoomReal && isNaN(a.zoomLevel) ? g / k > f / l ? .8 * k / g : .8 * l / f : a.zoomLevel, l =
                    this.zoomControl, k = d.fitToBounds(k,
                    l.minZoomLevel,
                    l.maxZoomLevel), isNaN(a.zoomX) &&
                    isNaN(a.zoomY) &&
                    isNaN(a.zoomLatitude) &&
                    isNaN(a.zoomLongitude) &&
                    (a = this.mapSet.getBBox(), this.zoomToMapXY(k, -a.x * b + c + g / 2, -a.y * b + e + f / 2)));
                this.zoomControl.update()
            }
        },
        ...
        zoomTo: function(a, b, c, e) {
            ...
            this.stopAnimation();
            isNaN(a) ||
            (g = this.mapContainer, this.initialX = g.x, this.initialY = g.y, this.initialScale =
                g.scale, this.finalX = this.mapWidth * b, this.finalY = this.mapHeight * c, this.finalScale =
        ...
        processObjects: function() {
            ...
            if (0 < a.images.length || 0 < a.areas.length || 0 < a.lines.length || a == this.dataProvider) {
                ...
                this.linesAboveImages
                    ? (d.toFront(), c.toFront(), f.toFront(), e.toFront())
                    : (f.toFront(), e.toFront(), d.toFront(), c.toFront());
                a &&
            ...
            if (!a.showAsSelected && b && !a.isOver) {
                ...
                if (void 0 != c)
                    if ("MapImage" == a.objectType) (e = a.image) && e.setAttr("fill", c);
                        ...
                        a.objectType) {
                        if ((e = a.lineSvg) && e.setAttr("stroke", c), e =
                            a.arrowSvg) e.setAttr("fill", c), e.setAttr("stroke", c)
                ...
                "MapImage" == a.objectType
                    ? (c = this.imagesSettings.rollOverOutlineThickness, (e = a.image) &&
            ...
            if (this.chartCreated) {
                ...
                if (!this.preventHover) {
                    ...
                    this.showDescriptionOnHover
                        ...
                        !1 === b ||
                        (g = this.balloon, this.balloon.fixedPosition = !1, b = a.colorReal, d =
                                "", void 0 !== b && this.useObjectColorForBalloon || (b = g.fillColor), (g =
                                    a.balloonTextReal) &&
                                (d = this.formatString(g, a)), this.balloonLabelFunction &&
        ...
        formatString: function(a, b) {
            ...
            return a = d.massReplace(a,
                { "[[title]]": g, "[[value]]": f, "[[percent]]": c, "[[description]]": e, "[[customData]]": h })
        },
        ...
        extendMapData: function(a) {
            ...
            if ("MapImage" != b && "MapArea" != b && "MapLine" != b)
                return d.extend(a, new d.MapData, !0), this.dataProvider = a, this.zoomInstantly =
        ...
        coordinateToLatitude: function(a) {
            ...
            if (this.mapSet) {
                ...
                b = this.mapHeight;
                "mercator" == c.projection
                    ? (c = this.mercatorLatitudeToCoordinate(e), g = this.mercatorLatitudeToCoordinate(g), a =
                        2 * Math.atan(Math.exp(2 * (a * (c - g) / b + g) * Math.PI / 180)) - .5 * Math.PI, b =
                ...
                for (g = 0; g < k; g++) {
                    ...
                    if (0 !== f.childNodes.length || "" !== m || !1 !== n)
                        if (3 == f.nodeType || 4 == f.nodeType) {
                            ...
                            void 0 !== a[b][l]
                                ? void 0 === a[b][l].length
                                ? (r = a[b][l], a[b][l] = [], a[b][l].push(r), a[b][l].push({}), r = a[b][l][1])
                                : "object" == typeof a[b][l] && (a[b][l].push({}), r = a[b][l][a[b][l].length - 1])
                                : (a[b][l] = {}, r = a[b][l]);
                            if (f.attributes && f.attributes.length)
                                for (m = 0; m < f.attributes.length; m++)
                                    r[f.attributes[m].name] = f.attributes[m].value;
                            void 0 !== a[b][l].length
...
(function() {
    ...
    d.ZoomControl = d.Class({
        ...
        init: function(a, b) {
            ...
            isNaN(c.bottom) ||
            (v = a.getY(c.bottom, !0), f && (v -= q + 3 * g), v =
                h ? v - 3 * g : c.homeButtonEnabled ? v - .5 * g : v + g);
            e.translate(u, v);
            c.previousDY = NaN;
            var F, u = g / 4 - 1;
            if (f) {
                ...
                d.setCN(a, f, "zoom-bg");
                f.translate(-3, -3);
                f.mouseup(function() { c.handleBgUp() }).touchend(function() { c.handleBgUp() });
                F.push(f);
                var E = g;
                x && (E = g / 1.5);
                c.draggerSize = E;
                ...
                for (B = 1; B < G; B++)
                    v = g + B * f, v =
                        d.line(b, [1, E - 2], [v, v], c.gridColor, c.gridAlpha, 1), d.setCN(a, v, "zoom-grid"), I.push(
                        v);
                ...
                v = new d.SimpleButton;
                D
                    ? (E = b.set(), G = d.line(b, [-u, u], [0, 0], w, A, 1), B =
                        d.line(b, [0, 0], [-u, u], w, A, 1), E.push(G), E.push(B), v.svgIcon = E)
                ...
                v = new d.SimpleButton;
                D
                    ? v.svgIcon = d.line(b, [-u, u], [0, 0], w, A, 1)
            ...
            h &&
            (h = b.set(), d.setCN(a, h, "zoom-control-pan"), e.push(h), F && F.translate(g, 4 * g), y =
                    new d.SimpleButton, D
                    ? y.svgIcon = d.line(b, [u / 5, -u + u / 5, u / 5], [-u, 0, u], w, A, 1)
                    : y.setIcon(a.pathToImages +
                        "panLeft.gif",
                        c.iconSize), y.setClickHandler(a.moveLeft, a), y.init(b, g, g, k, l, m, n, r, t, p, A, w, x),
                y.set.translate(0, g), d.setCN(a, y.set, "pan-left"), h.push(y.set), y =
                    new d.SimpleButton,
                D
                    ? y.svgIcon = d.line(b, [-u / 5, u - u / 5, -u / 5], [-u, 0, u], w, A, 1)
                    : y.setIcon(a.pathToImages + "panRight.gif", c.iconSize), y.setClickHandler(a.moveRight, a),
                y.init(b, g, g, k, l, m, n, r, t, p, A, w, x), y.set.translate(2 * g, g),
                d.setCN(a, y.set, "pan-right"),
                h.push(y.set), y = new d.SimpleButton, D
                    ? y.svgIcon = d.line(b, [-u, 0, u], [u / 5, -u + u / 5, u / 5], w, A, 1)
                    : y.setIcon(a.pathToImages +
                        "panUp.gif",
                        c.iconSize), y.setClickHandler(a.moveUp, a), y.init(b, g, g, k, l, m, n, r, t, p, A, w, x),
                y.set.translate(g, 0), d.setCN(a, y.set, "pan-up"), h.push(y.set), y =
                    new d.SimpleButton, D
                    ? y.svgIcon = d.line(b, [-u, 0, u], [-u / 5, u - u / 5, -u / 5], w, A, 1)
                    : y.setIcon(a.pathToImages + "panDown.gif", c.iconSize), y.setClickHandler(a.moveDown, a),
                y.init(b, g, g, k, l, m, n, r, t, p, A, w, x), y.set.translate(g, 2 * g), d.setCN(a, y.set, "pan-down"),
                h.push(y.set), e.push(h));
            c.homeButtonEnabled &&
            (h = new d.SimpleButton, D
                    ? h.svgIcon = d.polygon(b,
                        [
                            -u, 0, u, u - 1, u - 1,
                            2, 2, -2, -2, -u + 1, -u + 1
                        ],
                        [0, -u, 0, 0, u - 1, u - 1, 2, 2, u - 1, u - 1, 0],
                        w,
                        A,
                        1,
                        w,
                        A)
                    : h.setIcon(a.pathToImages + c.homeIconFile, c.iconSize), h.setClickHandler(a.goHome, a),
                c.panControlEnabled && (r = l = 0), h.init(b, g, g, k, l, m, n, r, t, p, A, w, x), c.panControlEnabled
                    ? h.set.translate(g, g)
                    : F && F.translate(0, 1.5 * g), d.setCN(a, h.set, "pan-home"), e.push(h.set));
            c.update()
        },
        ...
        update: function() {
            ...
            h &&
            (this.isDragging
                ? (h.stopDrag(), a = g.y + (h.mouseY - this.previousY), a =
                    d.fitToBounds(a, f, this.realGridHeight + f), c =
                    100 * Math.pow(b, e - (a - f) / c), h.zoomTo(c, NaN, NaN, !0))
                : (a = Math.log(h.zoomLevel() / 100) / Math.log(b), a = (e - a) * c + f), this.previousY =
                h.mouseY, this.previousDY != a &&
                g &&
                (g.translate((this.buttonSize - this.draggerSize) / 2, a), this.previousDY = a))
        }
    })
})();
(function() {
    ...
    d.SimpleButton = d.Class({
        ...
        init: function(a, b, c, e, g, f, h, k, l, m, n, r, t) {
            ...
            q &&
            (m.push(q), q.setAttr("opacity",
                n), q.node.style.pointerEvents = "none");
            e.mousedown(function() { p.handleDown() }).touchstart(function() { p.handleDown() })
                .mouseup(function() { p.handleUp() }).touchend(function() { p.handleUp() })
                .mouseover(function() { p.handleOver() }).mouseout(function() { p.handleOut() });
            p.bg = e
        },
    ...
    d.SmallMap = d.Class({
        ...
        init: function(a, b) {
            ...
            if (c.enabled) {
                ...
                a.svgIcons
                    ? n.svgIcon = d.line(b, [-r / 2, 0, r / 2], [-r / 4, r / 4, -r / 4], c.iconColor, 1, 1)
                    : n.setIcon(a.pathToImages +
                        "arrowDown.gif",
                        k);
                ...
                a.svgIcons
                    ? t.svgIcon = d.line(b, [-r / 2, 0, r / 2], [r / 4, -r / 4, r / 4], c.iconColor, 1, 1)
                ...
                n.translate(p, q);
                h.translate(p, q);
                g.mouseup(function() { c.handleMouseUp() });
                c.drawRectangle()
    ...
    d.AreasProcessor = d.Class({
        ...
        process: function(a) {
            ...
            for (d = 0; d < c; d++)
                g = a[d],
                    isNaN(g.value)
                        ? g.percents = void 0
                        : (g.percents = (g.value - k) / f * 100, k == h && (g.percents = 100));
        ...
        updateAllAreas: function() {
            ...
            for (n = 0; n < h.length; n++) {
                ...
                k.getAreasFromMap &&
                    !m[l.id] &&
                    (t = new d.MapArea(a.theme), t.parentObject = k, t.id = l.id, k.areas.push(t))
            }
        },
        createArea: function(a) {
            ...
            var f = e.color,
                ...
                m = e.selectedColor,
                n = e.rollOverAlpha,
                r = e.rollOverBrightness,
                t = e.outlineColor,
                p = e.outlineAlpha,
                q = e.balloonText,
                y = e.selectable,
                z = e.pattern,
                C = e.rollOverOutlineColor,
            ...
            void 0 == e.colorSolid ||
                ...
                (q = Math.floor((a.value - this.minValue) / ((this.maxValue - this.minValue) / b.colorSteps)),
                    q == b.colorSteps && q--, q *= 1 / (b.colorSteps - 1), this.maxValue == this.minValue && (q = 1),
            ...
            if (c &&
            (r = c.area, A = c.title, a.enTitle = c.title, A && !a.title && (a.title = A), (c = b.language)
                ? (A = d.mapTranslations) && (c = A[c]) && c[a.enTitle] && (a.titleTr = c[a.enTitle])
                : a.titleTr = void 0, r)) {
                a.displayObject = r;
                ...
                (r.setAttr("fill", D), r.setAttr("stroke", f), r.setAttr("stroke-opacity", t),
                    r.setAttr("stroke-width", p), r.setAttr("fill-opacity", x));
    ...
    d.ImagesProcessor = d.Class({
        ...
        createImage: function(a, b) {
            ...
            var k = h.color,
                ...
                w = h.labelColor,
                x = h.labelFontSize,
                D = h.bringForwardOnHover,
                u = h.labelRollOverColor,
                v = h.rollOverBrightness,
            ...
            if (C) {
                ...
                "kilometers" == a.widthAndHeightUnits &&
                    (F = c.kilometersToPixels(a.width), q = c.kilometersToPixels(a.height));
                ...
                u = v = 0;
                a.centeredReal
                    ? (isNaN(a.right) || (v = F * n), isNaN(a.bottom) || (u = q * n))
                    : (v = F * n / 2, u = q * n / 2);
                B.translate(v, u, n, !0)
            } else
                z
                    ? (isNaN(F) && (F = 10), isNaN(q) && (q = 10), B =
                            e.image(z, 0, 0, F, q), B.node.setAttribute("preserveAspectRatio", "none"),
                        B.setAttr("opacity", k), a.centeredReal &&
                        (v = isNaN(a.right) ? -F / 2 : F / 2, u =
                            isNaN(a.bottom) ? -q / 2 : q / 2, B.translate(v, u, NaN, !0)))
                    : x &&
                    (B = e.path(x), t = B.getBBox(), a.centeredReal
                        ? (v = -t.x * n - t.width * n / 2, isNaN(a.right) || (v = -v), u = -t.y * n -
                            t.height *
                            n /
                            2, isNaN(a.bottom) || (u = -u))
                        : v = u = 0, B.translate(v, u, n, !0), B.x = v, B.y = u);
            B &&
            (E.push(B), a.image =
                    B, B.setAttr("stroke-opacity", l), B.setAttr("fill-opacity", k), B.setAttr("fill", G),
                d.setCN(c, B, "map-image"), void 0 != a.id && d.setCN(c, B, "map-image-" + a.id));
            G = a.labelColorReal;
            !a.showAsSelected && c.selectedObject != a ||
                void 0 == h ||
                (B.setAttr("fill", h), G = a.selectedLabelColorReal);
            B = null;
            void 0 !== a.label &&
            (B = d.text(e, a.label, G, c.fontFamily, a.labelFontSizeReal, a.labelAlign), d.setCN(c,
                    B,
                    "map-image-label"), void 0 !== a.id &&
                    d.setCN(c,
                        B,
                        "map-image-label-" + a.id), G = a.labelBackgroundAlpha, (k = a.labelBackgroundColor) &&
                    0 < G &&
                    (l = B.getBBox(), e =
                            d.rect(e, l.width + 16, l.height + 10, k, G), d.setCN(c, e, "map-image-label-background"),
                        void 0 != a.id && d.setCN(c, e, "map-image-label-background-" + a.id), E.push(e), a.labelBG =
                            e),
                a.imageLabel =
                    B, E.push(B), d.setCN(c, E, "map-image-container"), void 0 != a.id &&
                    d.setCN(c, E, "map-image-container-" + a.id));
            e = isNaN(a.latitude) || isNaN(a.longitude) ? !0 : !1;
            a.lineId &&
                (B = this.chart.getObjectById(a.lineId)) &&
                0 < B.longitudes.length &&
                (e = !1);
            e ? f.push(E) : g.push(E);
        ...
        updateSizeAndPosition: function(a) {
            ...
            if (a.lineId) {
                ...
                (a.line = t) &&
                    t.getCoordinates &&
                    (t.chart = b, t = t.getCoordinates(m, a.lineSegment)) &&
                    (k = b.coordinateToLongitude(t.x), l = b.coordinateToLatitude(t.y), f = d.radiansToDegrees(t.angle))
            }
            isNaN(f) ||
                c.rotate(f +
                    a.extraAngle);
            if (!isNaN(e) && !isNaN(g)) c.translate(e, g, NaN, !0);
                ...
                if (e = b.longitudeToCoordinate(k), g = b.latitudeToCoordinate(l), a.fixedSize) {
                    f = 1;
        ...
        positionLabel: function(a, b, c) {
            if (a) {
                ...
                d &&
                (k = d.getBBox(), f = d.y, g = d.x, h = k.width, k =
                    k.height, b.svgPath && (h *= b.scale, k *= b.scale));
                ...
                b.labelBG &&
                    b.labelBG.translate(g - d.width / 2 + b.labelShiftX - 9,
                        f +
                        b.labelShiftY -
                        d.height /
                        2 -
        ...
        createPredefinedImage: function(a, b, c, e, g, f) {
            ...
            case "hexagon":
                g /= Math.sqrt(3), k = d.polygon(h,
                    [.866 * g, 0 * g, -.866 * g, -.866 * g, 0 * g, .866 * g],
                    [.5 * g, 1 * g, .5 * g, -.5 * g, -1 * g, -.5 * g],
                    a,
                    1,
                    c,
                    b,
        ...
        createLine: function(a, b) {
            ...
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                if (0 < w.length) {
                    ...
                    a.distances = [];
                    if (isNaN(n)) {
                        for (n = 0; n < w.length - 1; n++)
                            G = D[n], q = D[n + 1], G =
                                Math.sqrt(Math.pow(w[n + 1] - w[n], 2) + Math.pow(q - G, 2)), a.distances[n] = G;
                    ...
                    if ("none" != x) {
                        ...
                        if ("end" == x || "both" == x)
                            p = w[w.length - 1], q =
                                D[D.length - 1], 1 < w.length
                                ? (k = w[w.length - 2], H = D[D.length - 2])
                                : (k = p, H = q), H =
                                180 * Math.atan((q - H) / (p - k)) / Math.PI, isNaN(E) || (H += E), K = p, L = q, H =
                                0 > p - k ? H - 90 : H + 90;
                        "both" == x &&
                        (p = d.polygon(u, [-t / 2, 0, t / 2], [1.5 * t, 0, 1.5 * t], m, r, 1, m, r), v.push(p),
                            p.translate(K, L, 1, !0), isNaN(H) || p.rotate(H), d.setCN(c,
                                n,
                                "map-line-arrow"), void 0 != a.id && d.setCN(c, n, "map-line-arrow-" + a.id), a
                                .fixedSize &&
                                g.push(p));
                        if ("start" == x || "both" == x)
                            p = w[0], L = D[0], 1 < w.length ? (k = w[1], K = D[1]) : (k = p, K = L), H =
                                180 * Math.atan((L - K) / (p - k)) / Math.PI, isNaN(E) || (H -= E), K = p, H =
                                0 > p - k ? H - 90 : H + 90;
                        "middle" == x &&
                        (p = w[w.length - 1], q =
                                D[D.length - 1], 1 < w.length
                                ? (k = w[w.length - 2], H = D[D.length - 2])
                                : (k = p, H = q),
                            K = k + (p - k) / 2, L = H + (q - H) / 2, H =
                                180 * Math.atan((q - H) / (p - k)) / Math.PI, isNaN(E) ||
                            (E = G / 2, B -= Math.sqrt(B * B - E * E), 0 > A && (B = -B), E =
                                Math.sin(H / 180 * Math.PI), -1 == E && (E = 1), K -=
                    ...
                    a.fixedSize &&
                        n &&
                        (c = { line: n, thickness: F }, this.linesToResize.push(c),
                            a.arrays.push({ arr: this.linesToResize, el: c }), c =
                                { line: l, thickness: 5 }, this.linesToResize.push(c), a.arrays.push({
        ...
        getCoordinates: function(a, b) {
            ...
            if (!isNaN(a)) {
                ...
                1 < this.longitudes.length
                    ? (c = this.chart.longitudeToCoordinate(this.longitudes[b]), g =
                        this.chart.longitudeToCoordinate(this.longitudes[b + 1]), e =
                        this.chart.latitudeToCoordinate(this.latitudes[b]), f =
...
(function() {
    ...
    d.MapImage = d.Class({
        ...
        animate: function() {
            ...
            a.frame = 0;
            a.clearTO();
            a.timeOut = setTimeout(function() { a.update.call(a) }, d.updateRate);
            b = {
                type: "animationStart",
                chart: a.chart,
                image: this,
        ...
        update: function() {
            ...
            a.frame <= c
                ? (e = e(0, a.frame, 0, 1, c),
                    -1 == a.direction && (e = 1 - e), a.animatingAlong
                        ? a.positionOnLine = e
                        : (c =
                                a.initialX + (a.finalX - a.initialX) * e, isNaN(a.longitude) || (a.longitude = c),
                            isNaN(a.left) || (a.left = c), isNaN(a.right) || (a.right = c), e =
                                a.initialY + (a.finalY - a.initialY) * e, isNaN(a.latitude) || (a.latitude = e),
                            isNaN(a.top) || (a.top = e), isNaN(a.bottom) || (a.bottom = e)), a.clearTO(), a.timeOut =
...
(function() {
    var d = window.AmCharts;
    d.degreesToRadians = function(a) { return a / 180 * Math.PI };
    d.radiansToDegrees = function(a) { return a / Math.PI * 180 };
...
(function() {
    ...
    d.DescriptionWindow = d.Class({
        ...
        show: function(a, b, c, d) {
            ...
            l.onclick = function() { g.close() };
            l.onmouseover = function() { l.src = a.pathToImages + "xIconH" + k };
            l.onmouseout = function() { l.src = a.pathToImages + "xIcon" + k };
            f.appendChild(l);
            b = document.createElement("div");
            b.className = "ammapDescriptionTitle " + h + "title-div";
            b.onmousedown = function() { g.div.style.zIndex = 1E3 };
            f.appendChild(b);
    ...
    d.ValueLegend = d.Class({
        ...
        init: function(a, b) {
            if (this.enabled) {
                ...
                void 0 !== k &&
                (h = d.text(b, k, n, m, l, "left"), h.translate(0, l / 2 - 1), d.setCN(a,
                    h,
                    "value-legend-min-label"), f.push(h), h = h.getBBox().height);
                k = this.maxValue;
                void 0 === k && (k = a.maxValueReal);
                void 0 !== k &&
                (h = d.text(b, k, n, m, l, "right"), h.translate(this.width, l / 2 - 1), d.setCN(a,
                    h,
                    "value-legend-max-label"), f.push(h), h = h.getBBox().height);
                if (this.showAsGradient)
                    c = d.rect(b,
                        ...
                        1,
                        0,
                        0), d.setCN(a, c, "value-legend-gradient"), c.translate(0, h), f.push(c);
                else
                    for (l = this.width / g, m = 0; m < g; m++)
                        n = d.getColorFade(c, e, 1 * m / (g - 1)), n =
                            d.rect(b, l, this.height, n, 1, this.borderThickness, this.borderColor, 1), d.setCN(a,
                            n,
                            "value-legend-color"), d.setCN(a, n, "value-legend-color-" + m), n.translate(l * m, h), f
                            .push(n);
                e = c = 0;
                g = f.getBBox();
    ...
    d.ObjectList = d.Class({
        ...
        addObjects: function(a, b) {
            ...
            if (a.images)
                for (g = 0; g < a.images.length; g++)
                    f = a.images[g], void 0 === f.showInList && (f.showInList = c.showImagesInList), this.addObject(f,
                        d);
            if (a.lines)
        ...
        addObject: function(a, b) {
            ...
            if (a.showInList &&
                ...
                b.appendChild(g);
                this.addObjects(a, g);
                h.onmouseover = function() { c.chart.rollOverMapObject(a, !1) };
                h.onmouseout = function() { c.chart.rollOutMapObject(a) };
                h.onclick = function() { c.chart.clickMapObject(a) }
            }
        }
    })
})();