(function() {
    ...
    d.AmStockChart = d.Class({
        ...
        write: function(a) {
            ...
            this.legendSettings = d.processObject(this.legendSettings,
                d.LegendSettings,
                b);
            ...
            this.dataSetSelector &&
                (this.dataSetSelector = d.processObject(this.dataSetSelector, d.DataSetSelector, b));
        ...
        updateData: function() {
            ...
            if (a) {
                ...
                if (d.ifArray(c)) {
                    ...
                    this.periodSelector &&
                        this.periodSelector.setRanges(this.firstDate,
                            this.lastDate);
                    a.dataParsed ||
                    (d.parseStockData(a, b.minPeriod, b.groupToPeriods, this.firstDayOfWeek, this.dataDateFormat), a
                        .dataParsed = !0);
                ...
                this.glueToTheEnd &&
                    ...
                    this.lastDate &&
                    (this.startDate =
                            new Date(this.startDate.getTime() + (this.lastDate.getTime() - this.endDate.getTime())),
                        this.endDate = this.lastDate, this.updateScrollbar = !0);
        ...
        updateComparingData: function() {
            ...
            for (c = 0; c < a.length; c++) {
                var e = a[c];
                e.dataParsed ||
                (d.parseStockData(e, b.minPeriod, b.groupToPeriods, this.firstDayOfWeek, this.dataDateFormat), e
                    .dataParsed = !0);
                this.updateEvents(e)
            }
        },
        createLayout: function() {
            ...
            if ("left" == b || "left" == c)
                a = document.createElement("div"), a.className = e + "-left-div", a.style.cssFloat =
                    "left", a.style.styleFloat = "left", a.style.width = "0px", a.style.position =
                    "absolute", d.appendChild(a), this.leftContainer = a;
            if ("right" == b || "right" == c)
                b = document.createElement("div"), b.className = e + "-right-div", b.style.cssFloat =
                    "right", b.style.styleFloat = "right", b.style.width =
                    "0px", d.appendChild(b), this.rightContainer = b;
        ...
        measurePanels: function(a) {
            ...
            if (this.div) {
                ...
                a || c == this.prevPH && this.prevPW == e || this.fire("resized", { type: "resized", chart: this });
                ...
                if (c != this.prevPH) {
                    ...
                    for (b = 0; b < a.length; b++)
                        if (l = a[b])
                            l.percentHeight = l.percentHeight / e * 100, l.panelBox &&
                            (l.panelBox.style.height =
                                Math.round(l.percentHeight * this.panelsHeight / 100) + "px");
                    this.prevPH = c
                }
            }
        },
        addStockPanel: function(a, b) {
            ...
            if (e = a.stockLegend)
                e = d.processObject(e, d.StockLegend, this.theme), e.container = void 0, e.title =
                    a.title, e.marginLeft = c.marginLeft, e.marginRight = c.marginRight, e.verticalGap = 3, e.position =
                    "top", d.copyProperties(this.legendSettings,
        ...
        updatePanel: function(a) {
            ...
            a.showCategoryAxis
                ...
                : (a.categoryAxis.labelsEnabled = !1, a.chartCursor && (a.chartCursor.categoryBalloonEnabled = !1));
            var c = a.valueAxes, e = c.length, f;
            0 === e &&
            (f = new d.ValueAxis(this.theme),
                a.addValueAxis(f));
        ...
        updatePanelsWithNewData: function() {
            ...
            if (a) {
                ...
                b &&
                (c = this.categoryAxesSettings, e = c.minPeriod, b.categoryField =
                        a.categoryField, 0 < a.dataProvider.length
                        ? (d = this.chartScrollbarSettings.usePeriod, b.dataProvider =
                            d ? a.agregatedDataProviders[d] : a.agregatedDataProviders[e])
                        : b.dataProvider = [], d = b.categoryAxis, d.minPeriod = e, d.firstDayOfWeek =
                        this.firstDayOfWeek, d.equalSpacing = c.equalSpacing, d.axisAlpha = 0, d.markPeriodChange =
                        c.markPeriodChange, b.bbsetr = !0, b.validateData(),
                    c = this.panelsSettings, b.maxSelectedTime = c.maxSelectedTime, b.minSelectedTime =
                        c.minSelectedTime);
        ...
        addChartScrollbar: function() {
            ...
            if (a.enabled) {
                ...
                var k;
                e &&
                (k = new d.AmGraph(this.theme), k.valueField = e.valueField, k.periodValue =
                    e.periodValue, k.type = e.type, k.connect = e.connect, k.minDistance =
                    a.minDistance, b.addGraph(k));
                ...
                "bottom" == a.position
                    ...
                    : c
                    ? "top" == c.position
                    ? f.insertBefore(k, e.nextSibling)
        ...
        handlePeriodSelectorZoom: function(a) {
            ...
            a.predefinedPeriod
                ? (this.predefinedStart =
                    a.startDate, this.predefinedEnd = a.endDate)
        ...
        addCursor: function(a) {
            ...
            if (b.enabled) {
                ...
                a.chartCursor &&
                (d.copyProperties(a.chartCursor, c), a.chartCursor.categoryBalloonFunction &&
                    (b = a.chartCursor.categoryBalloonFunction));
        ...
        zoomChart: function(a, b) {
            ...
            if (f && l) {
                ...
                if (k) {
                    ...
                    a.getTime() == b.getTime() &&
                        n != m &&
                        (b = d.changeDate(b, n.period, n.count), b.setTime(b.getTime() - 1))
                }
                ...
                (n.getTime() - f.getTime() <
                    .1 * z &&
                    (n = d.resetDateToMin(a, m.period, m.count, y)), l.getTime() - b.getTime() < .1 * z &&
                    (b = d.resetDateToMin(l, m.period, m.count, y), b = d.changeDate(b, m.period, m.count, !0)));
                ...
                for (f = 0; f < r.length; f++) {
                    ...
                    if (k != h) {
                        ...
                        if (e = l.chartCursor)
                            e.categoryBalloonDateFormat =
                                c.chartCursorSettings.categoryBalloonDateFormat(m.period), l.showCategoryAxis ||
                                (e.categoryBalloonEnabled = !1);
                    ...
                    0 < g.startDuration && c.animationPlayed && !e
                        ? (l.startDuration = 0, l.animateAgain())
                        : 0 < g.startDuration && !e && l.animateAgain()
                }
                c.animationPlayed = !0;
                g = d.newDate(b);
                x &&
                    c.updateScrollbar &&
                    (x.zoomToDates(a, g), c.skipScrollbarEvent = !0,
                        setTimeout(function() { c.resetSkip.call(c) }, 100));
                c.updateScrollbar = !0;
                c.startDate = a;
                c.endDate = b;
                p && p.zoom(a, b);
                c.skipEvents ||
                    a.getTime() == c.previousStartDate.getTime() && b.getTime() == c.previousEndDate.getTime() ||
                    (p = { type: "zoomed" }, p.startDate = a, p.endDate = b, p.chart = c, p.period =
                        k, c.fire(p.type, p), c.previousStartDate = d.newDate(a), c.previousEndDate = d.newDate(b))
            }
            c.eventsHidden && c.showHideEvents(!1);
            c.skipEvents ||
            (c.chartCreated || (k = "init", c.fire(k, { type: k, chart: c })), c.chartRendered ||
            (k = "rendered", c.fire(k,
                { type: k, chart: c }), c.chartRendered = !0), k = "drawn", c.fire(k, { type: k, chart: c }));
            c.chartCreated = !0;
            c.animationPlayed = !0
        },
            ...
            if (0 < this.dataSets.length) {
                ...
                for (b = 0; b < a.length; b++) {
                    ...
                    for (k = 0; k < l.length; k++) {
                        ...
                        x &&
                        (x = d.processObject(x, d.StockLegend, this.theme), c.stockLegend = x, y =
                            x.valueTextComparing, n = x.valueTextRegular, z = x.periodValueTextComparing, A =
                            x.periodValueTextRegular);
                        if (g.comparable) {
                            var B = f.length;
                            if (g.valueAxis) {
                                0 < B &&
                                ...
                                for (E = 0; E < B; E++) {
                                    ...
                                    if (p) {
                                        ...
                                        x &&
                                        (u && y
                                            ? (t.legendValueText = y, t.legendPeriodValueText = z)
                                            : (n && (t.legendValueText = n), t.legendPeriodValueText = A));
                                        c.showComparedOnTop ? c.graphs.push(t) : c.graphs.unshift(t);
                                        this.comparedGraphs.push({ graph: t, dataSet: C })
                                    }
                                }
                            }
                        }
                        x &&
                        (u && y
                            ? (g.legendValueText = y, g.legendPeriodValueText = z)
                            : (n && (g.legendValueText = n), g.legendPeriodValueText = A))
                    }
                }
            }
        },
        ...
        handleCursorChange: function(a) {
            ...
            for (l = 0; l < f.length; l++) {
                ...
                k != b &&
                    c &&
                    (k.isZooming(d), k.previousMousePosition = NaN, k.forceShow = !0, k.initialMouse =
                        b.initialMouse, k.selectionPosX =
                        b.selectionPosX, k.setPosition(c, !1, a, this.chartCursorSettings.onePanelOnly))
            }
        },
        getSelections: function() {
            ...
            b = this.panels;
            for (c = 0; c < b.length; c++)
                d = b[c], "never" != d.recalculateToPercents && 0 < a.length
        ...
        invalidateSize: function() {
            ...
            var b = setTimeout(function() { a.validateNow() }, 5);
            a.validateTO = b
        },
        measure: function() {
            var a = this.div;
        ...
        validateSizeReal: function() {
            ...
            if (this.divRealWidth != this.previousWidth || this.divRealHeight != this.previousHeight)
                0 < this.divRealWidth &&
                    ...
                    this.fire("resized", { type: "resized", chart: this }), this.divRealHeight != this.previousHeight &&
                    this.validateNow()
        },
        clear: function(a) {
            var b = this.panels, c;
    ...
    d.StockEvent = d.Class({ construct: function() {} })
})();
(function() {
    var d = window.AmCharts;
    d.DataSet = d.Class({
    ...
    d.PeriodSelector = d.Class({
        ...
        write: function(a) {
            ...
            if (b.inputFieldsEnabled) {
                ...
                g.onblur = function(a) { b.handleCalChange(a) };
                d.isNN && g.addEventListener("keypress", function(a) { b.handleCalendarChange.call(b, a) }, !0);
                d.isIE &&
                    g.attachEvent("onkeypress",
                        function(a) {
                ...
                e && d.applyStyles(g.style, e.PeriodInputField);
                g.style.textAlign = "center";
                g.onblur = function() { b.handleCalChange() };
                d.isNN &&
                    g.addEventListener("keypress",
                        ...
                        !0);
                d.isIE && g.attachEvent("onkeypress", function(a) { b.handleCalendarChange.call(b, a) });
                h.appendChild(g);
                b.endDateField = g;
            ...
            if (d.ifArray(h)) {
                ...
                for (a = 0; a < h.length; a++)
                    g = h[a], r = document.createElement("input"),
                        r.type = "button", r.value = g.label, r.period = g.period, r.count = g.count, r.periodObj =
                            g, r.className =
                            "amChartsButton " + c + "-period-input", e && d.applyStyles(r.style, e.PeriodButton),
                        f && (r.style.width = b.width - 1 + "px"), r.style.boxSizing =
                            "border-box", m.appendChild(r), b.addEventListeners(r), g.button = r;
        ...
        addEventListeners: function(a) {
            var b = this;
            d.isNN && a.addEventListener("click", function(a) { b.handlePeriodChange.call(b, a) }, !0);
            d.isIE &&
        ...
        selectPeriodButton: function(a, b, c) {
            ...
            g &&
                ...
                ("MAX" == l
                        ...
                        : "YTD" == l
                        ? (h =
                            new Date, h.setMonth(0, 1), h.setHours(0, 0, 0, 0), 0 === f && h.setDate(h.getDate() - 1),
                        m =
                            this.lastDate)
                        : "YYYY" == l || "MM" == l
                        ? this.selectFromStart
                        ? (h = g, m = new Date(g), m.setMonth(m.getMonth() + f))
                        : (h = new Date(p), d.changeDate(h, l, f, !1), m = p)
                        : "fff" == l
                        ? (d.getPeriodDuration(l, f), r =
                                d.getPeriodDuration(l, f), this.selectFromStart
                                ? (h = g, m.setMilliseconds(g.getMilliseconds() - r + 1))
                                : (h = new Date(p.getTime()), h.setMilliseconds(h.getMilliseconds() - r + 1), m =
                                    this.lastDate)
                        )
                        : (r = d.getPeriodDuration(l, f), this.selectFromStart
                            ? (h = g, m = new Date(g.getTime() + r - 1))
                            : (h = new Date(p.getTime() - r + 1), m = p)), a.startTime =
                        h.getTime(),
                    this.hideOutOfScopePeriods &&
                        (b && a.startTime < g.getTime() ? e.style.display = "none" : e.style.display = "inline"),
                    h.getTime() > p.getTime() && (r = d.getPeriodDuration("DD", 1), h = new Date(p.getTime() - r)),
                    h.getTime() < g.getTime() && (h = g), "YTD" == l && (a.startTime = h.getTime()), a.endTime =
                        m.getTime(), b ||
                    (this.skipMark = !0, this.unselectButtons(), e.className =
                            "amChartsButtonSelected " + k.classNamePrefix + "-period-input-selected",
                        u && d.applyStyles(e.style, u.PeriodButtonSelected), a = { type: "changed" }, a.startDate =
                            h, a.endDate = m, a.predefinedPeriod = l, a.chart = this.chart, a.count = f, a.event =
                            c, this.fire(
                            a.type,
                            a)))
        },
            ...
            if (!this.skipMark) {
                ...
                for (l = b.length - 1; 0 <= l; l--) {
                    ...
                    k.startTime &&
                        ...
                        c == k.startTime &&
                        e == k.endTime &&
                        (this.unselectButtons(), h.className =
                            "amChartsButtonSelected " + a.classNamePrefix + "-period-input-selected", f &&
                            d.applyStyles(h.style, f.PeriodButtonSelected))
                }
            }
            this.skipMark = !1
        },
...
(function() {
    ...
    d.StockPanel = d.Class({
        ...
        construct: function(a) {
            ...
            this.panelHeaderPaddingBottom = this.panelHeaderPaddingLeft = this.panelHeaderPaddingRight =
                this.panelHeaderPaddingTop = 0;
        ...
        createDrawIcons: function() {
            ...
            l.setAttr("cursor",
                "pointer");
            l.mouseup(function() { a.handlePencilClick() });
            ...
            d.setCN(a, g, "eraser");
            a.eraserButton = g;
            k.mouseup(function() { a.handleEraserClick() });
            l.touchend &&
                (l.touchend(function() { a.handlePencilClick() }), k.touchend(function() { a.handleEraserClick() }));
        ...
        handleEraserClick: function() {
            ...
            if (this.eraseAll) {
                ...
                (this.erasingEnabled = b = !this.erasingEnabled)
                    ? (a && a.show(), this.setTrendColorHover(this.trendLineColorHover), this.setMouseCursor("auto"))
        ...
        hideDrawingIcons: function(a) { (this.hideIcons = a) && this.disableDrawing(a) },
        handleTrendClick: function(a) {
            this.erasingEnabled &&
                (a = a.trendLine, this.eraseAll || a.isProtected || this.removeTrendLine(a), this.validateNow())
        },
        handleWheelReal: function(a, b) {
            ...
            if (!this.wheelBusy && c) {
                ...
                0 > a
                    ? (d = this.startTime + d * f, f = this.endTime + 1 * f)
                    : (d = this.startTime - d * f, f = this.endTime - 1 * f);
    ...
    d.ChartCursorSettings = d.Class({
        construct: function(a) {
            ...
            this.categoryBalloonDateFormats = [
                { period: "YYYY", format: "YYYY" }, { period: "MM", format: "MMM, YYYY" },
                { period: "WW", format: "MMM DD, YYYY" }, { period: "DD", format: "MMM DD, YYYY" },
                { period: "hh", format: "JJ:NN" }, { period: "mm", format: "JJ:NN" },
...
(function() {
    ...
    d.addBr = function(a) { a.appendChild(document.createElement("br")) };
            ...
            for (p = 0; p < r; p++) {
                ...
                for (t = m; t < g; t++) {
                    ...
                    if (t == m || E >= x[u] || !x[u]) {
                        ...
                        var F;
                        for (F = 0; F < z; F++)
                            v = n[F].toField, w = y[u], q = Number(C[v]), w[v + "Count"] = 0, isNaN(q) ||
                            (w[v + "Open"] = q, w[v + "Sum"] = q, w[v + "High"] = q, w[v + "AbsHigh"] =
                                q, w[v + "Low"] = q, w[v + "Close"] = q, w[v + "Count"] = 1, w[v + "Average"] = q);
                        w.dataContext = A;
                        l[u].push(y[u]);
                        t > m &&
                        (v = d.newDate(B, b), v = d.changeDate(v, D, G, !0), v =
                            d.resetDateToMin(v, D, G, e), x[u] = v.getTime());
                        if (t == m) for (var H in A) A.hasOwnProperty(H) && (y[u][H] = A[H]);
                        y[u][h] = d.newDate(B, b)
                    } else
                        for (D = 0; D < z; D++)
                            v = n[D].toField, w = y[u], p == r - 1 && (w[h] = d.newDate(B, b)), q =
                                Number(C[v]), isNaN(q) ||
                            (isNaN(w[v + "Low"]) && (w[v + "Low"] = q), q < w[v + "Low"] && (w[v + "Low"] = q),
                                isNaN(w[v + "High"]) && (w[v + "High"] = q), q > w[v + "High"] && (w[v + "High"] = q),
                                isNaN(w[v + "AbsHigh"]) && (w[v + "AbsHigh"] = q), Math.abs(q) > w[v + "AbsHigh"] &&
                                    (w[v + "AbsHigh"] = q), w[v + "Close"] = q, G = d.getDecimals(w[v + "Sum"]), F =
                                    d.getDecimals(q), isNaN(w[v + "Sum"]) && (w[v + "Sum"] = 0), w[v + "Sum"] += q, w[
                                        v + "Sum"] =
                                    d.roundTo(w[v + "Sum"], Math.max(G, F)), w[v + "Count"]++, w[v + "Average"] =
                                    w[v + "Sum"] / w[v + "Count"])
                }
            }
        }
        ...
        for (var E in h)
            if (h.hasOwnProperty(E)) {
                ...
                for (v = 0; v < t; v++) {
                    ...
                    w = "fff" == x
                        ? g.getTime() + 1
                        : d.resetDateToMin(d.changeDate(new Date(g), C.period, C.count), x, A, e).getTime();
                    for (g = 0; g < m; g++)
                        for (y = b[g], x = y.graphs, r = x.length,
                            ...
                            for (A = 0; A < k.length; A++) {
                                ...
                                var F = !1;
                                n.graph &&
                                (n.graph.showEventsOnComparedGraphs && n.graph.comparedGraphs[a.id] && (F = !0),
                                    (u == n.graph || F) &&
                                        z >= G &&
                                        z < w &&
                                        (q.eventObjects.push(n), q.letters.push(n.text),
                                            q.descriptions.push(n.description),
                                            n.type ? q.shapes.push(n.type) : q.shapes.push(c.type),
                                            void 0 !== n.backgroundColor
                                                ? q.backgroundColors.push(n.backgroundColor)
                                                : q.backgroundColors.push(c.backgroundColor),
                                            isNaN(n.backgroundAlpha)
                                                ? q.backgroundAlphas.push(c.backgroundAlpha)
                                                : q.backgroundAlphas.push(n.backgroundAlpha),
                                            isNaN(n.borderAlpha)
                                                ? q.borderAlphas.push(c.borderAlpha)
                                                : q.borderAlphas.push(n.borderAlpha),
                                            void 0 !== n.borderColor
                                                ? q.borderColors.push(n.borderColor)
                                                : q.borderColors.push(c.borderColor),
                                            void 0 !== n.rollOverColor
                                                ? q.rollOverColors.push(n.rollOverColor)
                                                : q.rollOverColors.push(c.rollOverColor),
                                            void 0 !== n.showAt ? q.showAts.push(n.showAt) : q.showAts.push(c.showAt),
                                            void 0 !== n.fontSize && q.fontSizes.push(n.fontSize),
                                            q.colors.push(n.color), q.values.push(n.value), !n.panel &&
                                                n.graph &&
                                                (n.panel = n.graph.chart), q.showOnAxis.push(n.showOnAxis), q
                                                .showBullets.push(n.showBullet), q.date = new Date(n.date)));
                                0 < q.shapes.length &&
                                (n = "amCustomBullet" + u.id + "_" + y.id, z = "amCustomBulletConfig" +
                                    u.id +
                                    "_" +
                                    y.id, D[n] = d.StackedBullet, D[z] = q)
                            }
                        }
                }
            }
    ...
    d.StockLegend = d.Class({
        ...
        drawLegend: function() {
            ...
            if (b.allowTurningOff) {
                ...
                b.hide();
                a.xButtonHover = b;
                e.mouseup(function() { a.handleXClick() }).mouseover(function() { a.handleXOver() });
    ...
    d.DataSetSelector = d.Class({
        ...
        write: function(a) {
            ...
            if (1 < b.countDataSets("showInSelect")) {
                ...
                a.appendChild(p);
                d.isNN && p.addEventListener("change", function(a) { b.handleDataSetChange.call(b, a) }, !0);
                d.isIE && p.attachEvent("onchange", function(a) { b.handleDataSetChange.call(b, a) });
            ...
            if (0 < b.countDataSets("showInCompare") && 1 < l.length)
                if (k ? (d.addBr(a), d.addBr(a)) : (c = document.createTextNode(" "), a.appendChild(c)), c =
                    document.createTextNode(d.lang.compareText || b.compareText), a.appendChild(c), g =
                    b.listCheckBoxSize, k) {
                    d.addBr(a);
                    h = document.createElement("div");
                    a.appendChild(h);
                    h.className = "amChartsCompareList " + f.classNamePrefix + "-compare-div";
                    e &&
                        d.applyStyles(h.style,
                    ...
                    for (c = 0; c < l.length; c++)
                        m = l[c], !0 === m.showInCompare &&
                            m != b.chart.mainDataSet &&
                            (e = document.createElement("div"), e.style.padding = "4px", e.style.position =
                                    "relative", e.name = "amCBContainer", e.className =
                                    f.classNamePrefix + "-compare-item-div", e.dataSet = m, e.style.height =
                                    g + "px", m.compared && (e.style.backgroundColor = b.selectedBackgroundColor),
                                h.appendChild(e), k = document.createElement("div"),
                                k.style.width = g + "px", k.style.height = g + "px", k.style.position =
                                    "absolute", k.style.backgroundColor = m.color, e.appendChild(k), k =
                                    document.createElement("div"), k.style.width = "100%", k.style.position =
                                    "absolute", k.style.left = g + 10 + "px", e.appendChild(k), m =
                                    document.createTextNode(m.title), k.style.whiteSpace = "nowrap", k.style.cursor =
                                    "default", k.appendChild(m), b.addEventListeners(e));
                    d.addBr(a);
                    d.addBr(a)
                } else {
                    ...
                    d.isNN &&
                        f.addEventListener("change",
                            function(a) { b.handleCBSelect.call(b, a) },
                            !0);
                    d.isIE && f.attachEvent("onchange", function(a) { b.handleCBSelect.call(b, a) });
                    g = document.createElement("option");
        ...
        addEventListeners: function(a) {
            var b =
                this;
            d.isNN &&
            (a.addEventListener("mouseover", function(a) { b.handleRollOver.call(b, a) }, !0), a.addEventListener(
                "mouseout",
                function(a) { b.handleRollOut.call(b, a) },
                !0), a.addEventListener("click", function(a) { b.handleClick.call(b, a) }, !0));
            d.isIE &&
            (a.attachEvent("onmouseout", function(a) { b.handleRollOut.call(b, a) }), a.attachEvent("onmouseover",
                function(a) { b.handleRollOver.call(b, a) }), a.attachEvent("onclick",
                function(a) { b.handleClick.call(b, a) }))
        },
        ...
        handleRollOut: function(a) {
            a = this.getRealDiv(a);
            a.dataSet.compared ||
            (a.style.removeProperty && a.style.removeProperty("background-color"), a.style.removeAttribute &&
                a.style.removeAttribute("backgroundColor"))
        },
        handleCBSelect: function(a) {
            var b = this.compareCB, c = this.dataProvider, d, f;
            for (d = 0; d < c.length; d++)
                f = c[d], f.compared && (a = { type: "dataSetUncompared", dataSet: f }), f.compared = !1;
            c = b.selectedIndex;
            0 < c &&
            (f = this.dataProvider[b.options[c].value], f.compared || (a = { type: "dataSetCompared", dataSet: f }),
                f.compared = !0);
            b = this.chart;
            b.validateData();
            a.chart = b;
        ...
        handleClick: function(a) {
            ...
            !0 === a.compared
                ...
                : (a.compared = !0, a =
                    { type: "dataSetCompared", dataSet: a });
            var b = this.chart;
            b.validateData();
            a.chart = b;
            this.fire(a.type, a)
...
(function() {
    ...
    d.StackedBullet = d.Class({
        ...
        addLetter: function(a, b, c) {
            ...
            this.bullets[c] = n;
            this.showOnAxis
                ? (p = isNaN(this.nextAxisY) ? this.axisCoordinate : this.nextY, g = h * f, this.nextAxisY =
                    p + f * e)
                : this.value
                ? (p = this.value, k.recalculateToPercents && (p = p / k.recBaseValue * 100 - 100), p =
                    k.getCoordinate(p) - this.bulletY, g = h * f)
                : this.showAt
                ? (n = this.graphDataItem.values, k.recalculateToPercents && (n = this.graphDataItem.percents), n &&
                    (p = k.getCoordinate(n[this.showAt]) - this.bulletY, g = h * f))
                : (p = this.nextY, g = h * f);
            a.translate(m, g);
            b.push(a);
            b.translate(0, p);
        ...
        addEventListeners: function(a, b) {
            var c = this;
            a.click(function() { c.handleClick(b) }).mouseover(function() { c.handleMouseOver(b) }).touchend(
                function() {
                    c.handleMouseOver(b,
                        !0);
                    c.handleClick(b)
                }).mouseout(function() { c.handleMouseOut(b) })
        },
        drawPin: function(a) {
            var b = -1;
            this.stackDown && (b = 1);
        ...
        handleMouseOver: function(a, b) {
            ...
            var c = this.eventObjects[a],
                e = { type: "rollOverStockEvent", eventObject: c, graph: this.graph, date: this.date },
            ...
            this.chart.showBalloon(d.fixNewLines(c.description),
                f.stockEventsSettings.balloonColor,
                !0)
        },
        handleClick: function(a) {
            a = this.eventObjects[a];
            var b = { type: "clickStockEvent", eventObject: a, graph: this.graph, date: this.date },
