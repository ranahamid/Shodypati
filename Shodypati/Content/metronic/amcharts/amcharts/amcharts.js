(function() {
    ...
    window.AmCharts
        ? d = window.AmCharts
        : (d = {}, window.AmCharts = d, d.themes = {}, d.maps = {}, d.inheriting = {}, d.charts = [], d.onReadyArray =
            [], d.useUTC = !1, d.updateRate = 30, d.uid = 0, d.lang = {}, d.translations = {}, d.mapTranslations =
        ...
        a.inherits
            ...
            : (b.prototype.createEvents =
                ...
                b.prototype.listenTo = function(a, b, c) {
                    ...
                    for (var c = this.events[a], d = 0, k = c.length;
                        d <
                            k;
                        d++) {
                        var l = c[d];
    ...
    d.applyLang = function(a, b) {
        ...
        c &&
            (c = c[a]) &&
            (d.lang = c, c.monthNames &&
            (b.dayNames = d.extend({}, c.dayNames), b.shortDayNames = d.extend({}, c.shortDayNames), b.monthNames =
                d.extend({}, c.monthNames), b.shortMonthNames = d.extend({}, c.shortMonthNames)))
    };
    ...
    d.isNN &&
    (document.addEventListener("mousemove", d.handleMouseMove, !0), document.addEventListener("mouseup",
        d.handleMouseUp,
        !0), window.addEventListener("load",
        d.handleLoad,
        !0), window.addEventListener("DOMMouseScroll", d.handleWheel, !0), document.addEventListener("mousewheel",
        d.handleWheel,
        !0));
    d.isIE &&
    (document.attachEvent("onmousemove", d.handleMouseMove), document.attachEvent("onmouseup", d.handleMouseUp),
    ...
    d.clear = function() {
        ...
        d.charts = [];
        d.isNN &&
        (document.removeEventListener("mousemove", d.handleMouseMove, !0), document.removeEventListener("mouseup",
            d.handleMouseUp,
            !0), window.removeEventListener("load", d.handleLoad, !0), window.removeEventListener("DOMMouseScroll",
            d.handleWheel,
            !0), document.removeEventListener("mousewheel", d.handleWheel, !0));
        d.isIE &&
        (document.detachEvent("onmousemove", d.handleMouseMove), document.detachEvent("onmouseup", d.handleMouseUp),
    ...
    d.makeChart = function(a, b, c) {
        ...
        d.isReady
            ? isNaN(c)
            ? f.write(a)
            : setTimeout(function() { d.realWrite(f, a) }, c)
            : d.ready(function() { isNaN(c) ? f.write(a) : setTimeout(function() { d.realWrite(f, a) }, c) });
        return f
    };
...
(function() {
    ...
    d.wordwrap = function(a, b, c, e) {
        ...
        for (a = (k = a.split(/\r\n|\n|\r/)).length;
            ...
            for (k[h] = ""; g.length > b; k[h] += d.trim(g.slice(0, f)) + ((g = g.slice(f)).length ? c : ""))
                f = 2 == e || (f = g.slice(0, b + 1).match(/\S*(\s)?$/))[1]
                    ? b
    ...
    d.getStyle = function(a, b) {
        ...
        document.defaultView && document.defaultView.getComputedStyle
            ...
            : a.currentStyle &&
            (b = b.replace(/\-(\w)/g, function(a, b) { return b.toUpperCase() }), c = a.currentStyle[b]);
        return c
    };
    ...
    d.formatDuration = function(a, b, c, e, h, f) {
        ...
        "ss" == b &&
        (a = d.formatNumber(a, f), 1 == a.split(k)[0].length &&
        (a = "0" +
            a));
        ...
        if (g[h].count > g[b].count)
            for (a = g[b].count; a < g[h].count; a++)
                b = g[b].nextInterval, "ss" == b || "mm" == b || "hh" == b
                    ? c = "00" + e[b] + "" + c
                    : "DD" == b && (c = "0" + e[b] + "" + c);
    ...
    d.formatValue = function(a, b, c, e, h, f, g, k) {
        if (b) {
            ...
            for (l = 0; l < c.length; l++) {
                var m = c[l], n = b[m];
                void 0 !== n &&
                (n = f ? d.addPrefix(n, k, g, e) : d.formatNumber(n, e), a =
                    a.replace(new RegExp("\\[\\[" + h + "" + m + "\\]\\]", "g"), n))
            }
        }
        return a
    };
    ...
    d.addPrefix = function(a, b, c, e, h) {
        ...
        if (1 < a)
            for (k = b.length - 1;
                ...
                k--) {
                if (a >= b[k].number &&
                (l = a / b[k].number, m = Number(e.precision), 1 > m && (m = 1), c = d.roundTo(l, m), m =
                    d.formatNumber(c,
                        {
                            precision: -1,
            ...
            if (0 !== b)
                if ("[object Array]" === Object.prototype.toString.call(a))
                    ...
                    try {
                        for (c in a)
                            a[c] &&
                            ("object" == typeof a[c] && d.deleteObject(a[c], b - 1), "function" != typeof a[c] &&
                                (a[c] = null))
                    } catch (e) {
                    }
        }
    ...
    d.bounce = function(a, b, c, e, h) {
        return(b /= h) < 1 / 2.75
            ? 7.5625 * e * b * b + c
            : b < 2 / 2.75
            ? e * (7.5625 * (b -= 1.5 / 2.75) * b + .75) + c
            : b < 2.5 / 2.75
            ? e * (7.5625 * (b -= 2.25 / 2.75) * b + .9375) + c
            : e * (7.5625 * (b -= 2.625 / 2.75) * b + .984375) + c
    };
        ...
        for (var c in a) {
            ...
            if (0 < a[c].length && "object" == e)
                for (var h =
                        0;
                    h < a[c].length;
                    h++) e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c][h], e);
            else
                "object" == e
                    ? (e = document.createElementNS(d.SVG_NS, c), b.appendChild(e), d.parseDefs(a[c], e))
    ...
    d.AxisBase = d.Class({
        construct: function(a) {
            ...
            this.dateFormats = [
                ...
                { period: "DD", format: "MMM DD" }, { period: "WW", format: "MMM DD" }, { period: "MM", format: "MMM" },
        ...
        draw: function() {
            ...
            this.autoGridCount
                ? ("V" == this.orientation
                    ...
                    : a = this.width /
                    this.minHorizontalGap, this.gridCountR = Math.max(a, 1))
        ...
        positionTitle: function() {
            ...
            if (a) {
                ...
                0 < e.length()
                    ? h = e.getBBox()
                    : (h.x = 0, h.y = 0, h.width = this.viW, h.height =
                        this.viH, d.VML && (h.y += this.y, h.x += this.x));
                e.push(a);
                var e = h.x, f = h.y;
                ...
                case "right":
                    b = e + g + 10 + n, p && (b += 7), c =
                        ("left" == q ? l + 2 : "right" == q ? -2 : l / 2) + this.titleDY, m = -90
                }
            ...
            if (e = a.getLabel())
                this.labelsSet.push(e), e.click(function(b) {
                    c.handleMouse(b,
                        a,
                        "clickItem")
                }).mouseover(function(b) { c.handleMouse(b, a, "rollOverItem") }).mouseout(function(b) {
        ...
        chooseMinorFrequency: function(a) { for (var b = 10; 0 < b; b--) if (a / b == Math.round(a / b)) return a / b },
        parseDatesDraw: function() {
            ...
            if (g == v && 1 == w && this.centerLabelOnFullPeriod || this.autoWrap || this.centerLabels)
                n = z * this.stepWidth, this.autoWrap &&
                    !this.centerLabels &&
                    (n = -n);
            ...
            if (0 < this.gridCountR)
                for (B - 5 - k > this.autoRotateCount &&
                        ...
                        (this.labelRotationR = this.autoRotateAngle), a = k;
                    a <= B;
                    a++) {
                    ...
                    if ("radar" == b.type) {
                        ...
                        this.rotate
                            ? (h += this.x - this.viX, "date" == this.type &&
                                "middle" == this.gridPosition &&
                                (L = -z * this.stepWidth / 2))
                            : h = "date" == this.type
                            ? this.axisWidth - h + (this.y - this.viY)
                            : h + (this.y - this.viY);
                    f = !1;
                    ...
                    if (!isNaN(u))
                        for (h = 1; h < w; h += u)
                            this.gridAlpha = this.minorGridAlpha, f = q + A * h, f =
                                    d.resetDateToMin(new Date(f), v, u, r).getTime(),
                                f = new this.axisItemRenderer(this,
...
(function() {
    ...
    d.ValueAxis = d.Class({
        ...
        construct: function(a) {
            ...
            this.includeAllValues = this.recalculateToPercents = this.includeHidden = this.includeGuidesInMinMax =
                this.integersOnly = !1;
        ...
        updateData: function() {
            ...
            var a = this.chart;
            "xy" != a.type &&
            (this.stackGraphs("smoothedLine"), this.stackGraphs("line"),
            ...
            this.synchronizationMultiplier && this.synchronizeWith
                ? (d.isString(this.synchronizeWith) &&
                    (this.synchronizeWith = a.getValueAxisById(this.synchronizeWith)), this.synchronizeWith &&
        ...
        draw: function() {
            ...
            if (isNaN(this.min) ||
                ...
                !0 === h
                    ? (t = Math.log(this.max) * Math.LOG10E - Math.log(this.minReal) * Math.LOG10E, this.stepWidth =
                        this.axisWidth / t, t > this.logGridLimit &&
                    (r = Math.ceil(Math.log(this.max) * Math.LOG10E) + 1, f =
                        Math.round(Math.log(this.minReal) * Math.LOG10E), r > this.gridCountR &&
                        (q = Math.ceil(r / this.gridCountR))))
                ...
                if (0 < v) {
                    ...
                    for (g = this.fillAlpha = 0; g < v; g++) {
                        var B =
                            ...
                            C = B.above;
                        isNaN(B.toValue) ||
                        (D = this.getCoordinate(B.toValue), A =
                            new this.axisItemRenderer(this, D, "", !0, NaN, NaN, B), this.pushAxisItem(A, C));
                        var L = NaN;
                        isNaN(B.value) ||
                        (L = this.getCoordinate(B.value), A =
                            new this.axisItemRenderer(this, L, B.label, !0, NaN, (D - L) / 2, B), this.pushAxisItem(A,
                            C));
                        isNaN(D - L) ||
                        (A = new this.guideFillRenderer(this, L, D, B), this.pushAxisItem(A, C), A =
                            A.graphics(), B.graphics = A, B.balloonText && this.addEventListeners(A, B))
                    }
                    this.fillAlpha = z
                }
                this.exponential = !1;
                for (g = f; g < r; g += q)
                    w = d.roundTo(this.step *
                        g +
                        this.min,
                ...
                if ("date" == c)
                    this.generateDFObject(), this.timeDifference = this.max - this.min, this.maxTime = this.lastTime =
                        this.max, this.startTime = this.firstTime = this.min, this.parseDatesDraw();
                else
                    for (r >= this.autoRotateCount &&
                            !isNaN(this.autoRotateAngle) &&
                            (this.labelRotationR =
                                this.autoRotateAngle), g = f;
                        g < r;
                        g += q)
                        if (c = u * g + this.minCalc, h && this.max - this.min > 10 * this.min && (c -= this.min), c =
                            d.roundTo(c, this.maxDecCount + 1), !this.integersOnly || Math.round(c) == c)
                            if (isNaN(x) || Number(d.toFixed(c, x)) == c) {
                                !0 === h &&
                                    (0 === c && (c = this.minReal), t > this.logGridLimit && (c = Math.pow(10, g)));
                                ...
                                if (c == this.baseValue && "radar" != a.type) {
                                    ...
                                    v = this.viY;
                                    "H" == this.orientation
                                        ? 0 <= f && f <= z + 1 && (I = [f, f, f + k], W = [B, 0, l])
                                        : 0 <= f && f <= B + 1 && (I = [0, z, z + k], W = [f, f, f + l]);
                                    I &&
                                    (f = d.fitToBounds(2 * this.gridAlpha, 0, 1), f =
                                            d.line(a.container, I, W, this.gridColor, f, 1, this.dashLength),
                                        f.translate(A, v), this.grid0 =
                                            f, a.axesSet.push(f), f.toBack(), d.setCN(a,
                                            f,
                                            this.bcn + "zero-grid-" + this.id), d.setCN(a, f, this.bcn + "zero-grid"))
                                }
                                if (!isNaN(H) &&
                                    0 <
                                    w &&
                                    ...
                                    for (A = 1; A < u / H; A++)
                                        v = this.getCoordinate(c + H * A), v =
                                            new this.axisItemRenderer(this, v, "", !1, 0, 0, !1, !1, 0, !0), this
                                            .pushAxisItem(v);
                                    this.gridAlpha = f
                                }
                            }
        ...
        getDateMinMax: function() {
            ...
            (this.minimumDate instanceof Date ||
                (this.minimumDate = d.getDate(this.minimumDate, this.chart.dataDateFormat, "fff")), this.min =
                this.minimumDate.getTime());
            this.maximumDate &&
            (this.maximumDate instanceof Date ||
                (this.maximumDate = d.getDate(this.maximumDate, this.chart.dataDateFormat, "fff")), this.max =
        ...
        formatValue: function(a, b, c) {
            ...
            e
                ? (c = -1 == String(a).indexOf("e") ? a.toExponential(15) : String(a), e = c.split("e"), c =
                        Number(e[0]), e = Number(e[1]),
                    c = d.roundTo(c, 14), 10 == c && (c = 1, e += 1), c =
                        c + "e" + e, 0 === a && (c = "0"), 1 == a && (c = "1"))
                : (h &&
                (e = String(a).split("."), e[1]
                    ? (f.precision = e[1].length, 0 > c && (f.precision = Math.abs(c)), b && 1 < a && (f.precision = 0))
                    : f.precision = -1), c = this.usePrefixes
                    ? d.addPrefix(a, g.prefixesOfBigNumbers, g.prefixesOfSmallNumbers, f, !b)
                    : d.formatNumber(a, f, f.precision));
            this.duration &&
            (b && (f.precision = 0), c =
                d.formatDuration(a, this.duration, "", this.durationUnits, this.maxInterval, f));
            "date" == this.type &&
            (c = d.formatDate(new Date(a),
            ...
            for (l = this.start; l <= this.end; l++) {
                ...
                for (p = 0; p < k.length; p++)
                    if (n = k[p], n.hidden)
                        ...
                        if (m = this.data[l].axes[this.id].graphs[n.id], g =
                            m.values.value, isNaN(g)) n.newStack && (h[l] = NaN, e[l] = NaN);
                        else {
                            ...
                            (r &&
                                (isNaN(c[l])
                                    ? (c[l] = g, m.values.close = g, m.values.open = this.baseValue)
                                    : (isNaN(g)
                                        ? m.values.close =
                                        c[l]
                                        : m.values.close = g + c[l], m.values.open = c[l], c[l] = m.values.close)),
                                "column" == a &&
                                (n.newStack && (h[l] = NaN, e[l] = NaN), m.values.close = g, 0 > g
                                    ? (m.values.close =
                                            g, isNaN(e[l])
                                            ? m.values.open = q
                                            : (m.values.close += e[l], m.values.open = e[l]),
                                        e[l] = m.values.close)
                                    : (m.values.close =
                                            g, isNaN(h[l])
                                            ? m.values.open = q
                                            : (m.values.close += h[l], m.values.open = h[l]),
                                        h[l] = m.values.close)))
                        }
            }
            for (l = this.start; l <= this.end; l++)
                for (p = 0; p < k.length; p++)
                    (n = k[p], n.hidden)
                        ...
                        : (m = n.type, n.chart == this.chart &&
                            ...
                            a == m &&
                            n.stackable &&
                            (m = this.data[l].axes[this.id].graphs[n.id], g = m.values.value, isNaN(g) ||
                            (c = g / f[l] * 100, m.values.percents = c, m.values.total =
                                f[l], n.newStack && (h[l] = NaN, e[l] = NaN), "100%" == b &&
                            (isNaN(e[l]) && (e[l] = 0), isNaN(h[l]) && (h[l] = 0), 0 > c
                                ? (m.values.close = d.fitToBounds(c + e[l], -100, 100), m.values.open = e[l], e[l] =
                                    m.values.close)
                                : (m.values.close = d.fitToBounds(c + h[l], -100, 100), m.values.open = h[l], h[l] =
                                    m.values.close)))))
        },
                ...
                if (e.valueAxis == this) {
                    ...
                    if (m = a.recalculateFromDate)
                        m = d.getDate(m,
                            a.dataDateFormat,
                            "fff"), g =
                            a.getClosestIndex(a.chartData, "time", m.getTime(), !0, 0, a.chartData.length), k =
                            a.chartData.length - 1;
                    for (m = g;
                        m <= k &&
                        (g = this.data[m].axes[this.id].graphs[e.id], f = g.values[h], e.recalculateValue &&
                            (f = g.dataContext[e.valueField + e.recalculateValue]), isNaN(f));
                        m++);
                    this.recBaseValue = f;
                    for (h = l; h <= k; h++) {
        ...
        getMinMax: function() {
            ...
            if (this.includeGuidesInMinMax && 0 < a)
                for (b = 0; b < a; b++)
                    c = this.guides[b], c.toValue < this.min && (this.min = c.toValue),
                        c.value < this.min && (this.min = c.value), c.toValue > this.max && (this.max = c.toValue),
            ...
            1 > c
                ? (this.maxDecCount = Math.abs(Math.log(Math.abs(c)) * Math.LOG10E),
                    this.maxDecCount = Math.round(this.maxDecCount), this.step =
                        d.roundTo(this.step, this.maxDecCount + 1))
                : this.maxDecCount = 0;
            ...
            (2 < Math.log(b) * Math.LOG10E - Math.log(a) * Math.LOG10E
                ? (this.minReal = this.min = Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)), this.max =
                    Math.pow(10, Math.ceil(Math.log(Math.abs(b)) * Math.LOG10E)))
                : (b = Math.pow(10, Math.floor(Math.log(Math.abs(this.min)) * Math.LOG10E)) / 10, a =
                    Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E)) / 10, b < a &&
                (this.minReal = this.min = 10 *
                    a)))
        },
        getMin: function(a, b) {
            var c, e;
        ...
        zoomToValues: function(a, b) {
            var c = this.chart;
            "xy" == c.type
                ? (b < a && (c = b, b = a, a = c), a < this.min && (a = this.min), b > this.max && (b = this.max), c =
                    { type: "axisSelfZoomed" }, c.chart = this.chart, c.valueAxis = this, c.multiplier =
                    this.axisWidth / Math.abs(this.getCoordinate(b) - this.getCoordinate(a)), c.startValue =
                    a, c.endValue =
                    b, c.position =
                    "V" == this.orientation
                    ? this.reversed
                    ...
                    : this.reversed
                    ? this.getCoordinate(b)
                    : this.getCoordinate(a), this.fire(c.type, c))
        ...
        coordinateToValue: function(a) {
            ...
            return!0 === this.logarithmic
                ? Math.pow(10,
                    (d ? !0 === e ? (b - a) / c : a / c : !0 === e ? a / c : (b - a) / c) + Math.log(g) * Math.LOG10E)
                : !0 === e
                ? d
                ? f -
                (a - b) /
        ...
        getCoordinate: function(a) {
            ...
            var b = this.rotate,
                ...
                g = this.minReal;
            !0 === this.logarithmic
                ? (0 === a && (a = this.treatZeroAs), a = Math.log(a) * Math.LOG10E - Math.log(g) * Math.LOG10E, b =
                    b ? !0 === c ? e - d * a : d * a : !0 === c ? d * a : e - d * a)
                : b = !0 === c ? b ? e - d * (a - f) : d * (a - f) : b ? d * (a - f) : e - d * (a - f);
        ...
        handleSynchronization: function() {
            if (this.synchronizeWith) {
                ...
                e &&
                (this.min = b * e, this.max = c * e, this.step = a * e, b =
                    Math.pow(10, Math.floor(Math.log(Math.abs(this.step)) * Math.LOG10E)), b =
                    Math.abs(Math.log(Math.abs(b)) * Math.LOG10E), this.maxDecCount =
    ...
    d.RecAxis = d.Class({
        construct: function(a) {
            var b = a.chart,
                ...
                q = b.container;
            "H" == a.orientation
                ? (e = d.line(q, [0, p], [0, 0], e, h, c), this.axisWidth =
                    a.width, "bottom" == a.position
                    ? (k = c / 2 + f + n + m - 1, c = l)
                    : (k = -c / 2 - f + m + k, c = g + l))
                : (this.axisWidth = a.height, "right" == a.position
                    ? (e = d.line(q, [0, 0, -g], [0, n, n - k], e, h, c), k = m + k, c = c / 2 + f + g + p + l - 1)
                    : (e = d.line(q, [0, 0], [0, n], e, h, c), k = m, c = -c / 2 - f + l));
            e.translate(c,
                k);
            c = b.container.set();
            c.push(e);
    ...
    d.RecItem = d.Class({
        construct: function(a, b, c, e, h, f, g, k, l, m, n, p) {
            ...
            var ea = a.counter,
                ...
                ta;
            g
                ? (void 0 !== g.id && (p = q.classNamePrefix + "-guide-" + g.id), W =
                        !0, isNaN(g.tickLength) || (B = g.tickLength), void 0 != g.lineColor && (L = g.lineColor),
                    void 0 != g.color && (u = g.color), isNaN(g.lineAlpha) || (D = g.lineAlpha),
                    isNaN(g.dashLength) || (H = g.dashLength), isNaN(g.lineThickness) || (C = g.lineThickness),
                    !0 === g.inside && (Q = !0, 0 < ba && (ba = 0)), isNaN(g.labelRotation) ||
            ...
            W &&
                "" !== c &&
                (Z = a.autoWrap && 0 === n
                    ? d.wrappedText(x, c, u, r, t, fa, k, Math.abs(h), 0)
                    : d.text(x, c, u, r, t, fa, k), fa = Z.getBBox(), ga = fa.width, Ja = fa.height);
            if ("H" == Ra) {
                if (
                    0 <= b &&
                        b <= sa + 1 &&
                        (0 < B &&
                            0 < z &&
                            b + l <= sa + 1 &&
                            (da = d.line(x, [b + l, b + l], [0, B], v, z, C), A.push(da)), 0 < D &&
                            (ta = d.line(x, [b, b + qa, b + qa], [V, V + ka, ka], L, D, C, H), A.push(ta))), y = 0, E =
                        b, g && 90 == n && Q && (E -= t),
                    !1 === e
                        ? (fa = "start", y =
                            "bottom" == ca ? Q ? y + B : y - B : Q ? y - B : y + B, E += 3, 0 < h &&
                            (E += h / 2 - 3, fa = "middle"), 0 < n && (fa = "middle"))
                        : fa = "middle",
                    1 == ea &&
                        0 < I &&
                        !g &&
                        !m &&
                        aa < sa &&
                        (e = d.fitToBounds(b, 0, sa), aa = d.fitToBounds(aa, 0, sa), X = e - aa, 0 < X &&
                            (ya = d.rect(x, X, a.height, J, I), ya.translate(e - X + qa, ka), A.push(ya))),
                    "bottom" == ca
                        ? (y += V + t / 2 + ba, Q
                            ? (0 < n
                                ? (y = V - ga / 2 * Math.sin(S) - B - 3, E += ga / 2 * Math.cos(S) - 4 + 2)
                                : 0 > n
                                ? (y = V + ga * Math.sin(S) - B - 3 + 2, E += -ga * Math.cos(S) - Ja * Math.sin(S) - 4)
                                : y -= B + t + 3 + 3, y -= oa)
                            : (0 < n
                                ? (y = V + ga / 2 * Math.sin(S) + B + 3, E -= ga / 2 * Math.cos(S))
                                : 0 > n
                                ? (y = V + B + 3 - ga / 2 * Math.sin(S) + 2, E += ga / 2 * Math.cos(S))
                                : y += B + w + 3 + 3, y += oa))
                        : (y += ka + t / 2 - ba, E += qa, Q
                            ? (0 < n ? (y = ga / 2 * Math.sin(S) + B + 3, E -= ga / 2 * Math.cos(S)) : y += B + 3, y +=
                                oa)
                            : (0 < n
                                ? (y = -(ga / 2) * Math.sin(S) - B - 6, E += ga / 2 * Math.cos(S))
                                : y -= B + t + 3 + w + 3, y -= oa)), "bottom" == ca
                        ? X = (Q ? V - B - 1 : V + w - 1) + ba
                        : (la = qa, X = (Q ? ka : ka - B - w + 1) - ba), f && (E += f), f = E, 0 < n &&
                        (f += ga / 2 * Math.cos(S)), Z &&
                        (t = 0, Q && (t = ga / 2 * Math.cos(S)), f + t > sa + 2 || 0 > f)) Z.remove(), Z = null
            } else {
                0 <= b &&
                    b <= V + 1 &&
                    (0 < B &&
                        0 < z &&
                        b + l <= V + 1 &&
                        (da = d.line(x, [0, B + 1], [b + l, b + l], v, z, C), A.push(da)), 0 < D &&
                        (ta = d.line(x, [0, qa, sa + qa], [b, b + ka, b + ka], L, D, C, H), A.push(ta)));
                fa = "end";
                ...
                1 == ea &&
                    ...
                    !g &&
                    !m &&
                    (e = d.fitToBounds(b, 0, V), aa = d.fitToBounds(aa, 0, V), S = e - aa, ya =
                            d.polygon(x, [0, a.width, a.width, 0], [0, 0, S, S], J, I), ya.translate(qa, e - S + ka),
                        A.push(ya));
                y += t / 2;
                "right" == ca
                    ? (E += qa + sa + ba, y += ka, Q
                        ? (f || (y -= t / 2 + 3), E = E - (B + 4) - oa)
                        : (E += B + 4 + w, y -= 2, E += oa))
                    : Q
                    ? (E += B + 4 - ba, f || (y -= t / 2 + 3), g && (E += qa, y += ka), E += oa)
                    : (E += -B - w - 4 - 2 - ba, y -= 2, E -= oa);
                da &&
                ("right" == ca
                    ? (la += qa + ba + sa, X += ka, la = Q ? la - w : la + w)
                    : (la -= ba, Q || (la -= B + w)));
                f && (y += f);
                Q = -3;
                "right" == ca && (Q += ka);
            ...
            da &&
            (da.translate(la, X), d.setCN(q, da, a.bcn + "tick"), d.setCN(q, da, p, !0), g &&
                d.setCN(q, da, "guide"));
            !1 === a.visible && (da && da.remove(), Z && (Z.remove(), Z = null));
            Z &&
            (Z.attr({ "text-anchor": fa }), Z.translate(E,
                y,
                NaN,
                !0), 0 !== n && Z.rotate(-n, a.chart.backgroundColor), a.allLabels.push(Z), this.label =
                Z, d.setCN(q, Z, a.bcn + "label"), d.setCN(q, Z, p, !0), g && d.setCN(q, Z, "guide"));
...
(function() {
    ...
    d.RecFill = d.Class({
        construct: function(a, b, c, e) {
            ...
            "V" == g
                ? (b = d.fitToBounds(b, 0, a.viH), c = d.fitToBounds(c, 0, a.viH))
                : (b = d.fitToBounds(b, 0, a.viW), c = d.fitToBounds(c, 0, a.viW));
            c -= b;
            isNaN(c) && (c = 4, k = 2, m = 0);
            0 > c && "object" == typeof n && (n = n.join(",").split(",").reverse());
            "V" == g
                ? (g = d.rect(l, a.viW, c, n, m), g.translate(h, b - k + f))
                : (g = d.rect(l,
                    c,
                    a.viH,
                    n,
    ...
    d.AmChart = d.Class({
        construct: function(a) {
            ...
            this.prefixesOfSmallNumbers = [
                ...
                { number: 1E-9, prefix: "n" }, { number: 1E-6, prefix: "\u03bc" }, { number: .001, prefix: "m" }
            ];
        ...
        drawChart: function() {
            0 < this.realWidth &&
                0 < this.realHeight &&
                (this.drawBackground(), this.redrawLabels(), this.drawTitles(), this.brr(), this.renderFix(),
                    this.chartDiv &&
                    (this.boundingRect =
        ...
        drawBackground: function() {
            ...
            if (b = this.backgroundImage)
                a = a.image(b, 0, 0, h, f), d.setCN(this, b, "bg-image"), this.bgImg =
                    a, e.push(a)
        },
                ...
                for (e = 0; e < b.length; e++) {
                    ...
                    if (!1 !== h.enabled) {
                        ...
                        var k = this.marginLeft,
                            f = d.wrappedText(this.container,
                                h.text,
                                f,
                                this.fontFamily,
                                g,
        ...
        initChart: function() {
            ...
            d.applyLang(this.language,
                this);
            if (a = this.numberFormatter)
                isNaN(a.precision) || (this.precision = a.precision), void 0 !== a.thousandsSeparator &&
                    (this.thousandsSeparator = a.thousandsSeparator), void 0 !== a.decimalSeparator &&
            ...
            this.destroy();
            (a = this.container)
                ? (a.container.innerHTML = "", a.width = this.realWidth, a.height =
                    this.realHeight, a.addDefs(this), this.chartDiv.appendChild(a.container))
            ...
            a.chart = this;
            d.VML || d.SVG
                ? (a.handDrawn = this.handDrawn, a.handDrawScatter = this.handDrawScatter, a.handDrawThickness =
                        this.handDrawThickness,
                    this.set && this.set.remove(), this.set =
                        a.set(), this.gridSet && this.gridSet.remove(), this.gridSet =
                        a.set(), this.cursorLineSet && this.cursorLineSet.remove(), this.cursorLineSet =
                        a.set(), this.graphsBehindSet && this.graphsBehindSet.remove(), this.graphsBehindSet =
                        a.set(), this.bulletBehindSet && this.bulletBehindSet.remove(), this.bulletBehindSet =
                        a.set(), this.columnSet && this.columnSet.remove(), this.columnSet =
                        a.set(), this.graphsSet && this.graphsSet.remove(), this.graphsSet =
                        a.set(), this.trendLinesSet && this.trendLinesSet.remove(),
                    this.trendLinesSet = a.set(), this.axesSet && this.axesSet.remove(), this.axesSet =
                        a.set(), this.cursorSet && this.cursorSet.remove(), this.cursorSet =
                        a.set(), this.scrollbarsSet && this.scrollbarsSet.remove(), this.scrollbarsSet =
                        a.set(), this.bulletSet && this.bulletSet.remove(), this.bulletSet =
                        a.set(), this.freeLabelsSet && this.freeLabelsSet.remove(),
                    this.axesLabelsSet && this.axesLabelsSet.remove(), this.axesLabelsSet =
                    ...
                    this.zbSet && (this.zbSet.remove(), this.zbSet = null), this.zoomButtonSet =
                        a.set(), this.linkSet && this.linkSet.remove(), this.linkSet = a.set())
        ...
        measure: function() {
            ...
            if (a) {
                ...
                (c != this.previousWidth || e != this.previousHeight) &&
                    0 < a &&
                    0 < f &&
                    (b.style.width = a + "px", b.style.height = f + "px", b.style.padding =
                        0, h && h.setSize(a, f), this.balloon =
                        d.processObject(this.balloon, d.AmBalloon, this.theme), this.balloon.setBounds(2, 2, a - 2, f));
                this.balloon.chart = this;
                this.realWidth = a;
                this.realHeight = f;
                this.divRealWidth = c;
        ...
        checkDisplay: function() {
            if (this.autoDisplay && this.container) {
                ...
                0 === b.width &&
                    0 === b.height &&
                    (this.divRealHeight = this.divRealWidth = this.realHeight = this.realWidth = 0, this.previousWidth =
        ...
        clear: function(a) {
            d.callMethod("clear",
                [
                    this.chartScrollbar, this.scrollbarV, this.scrollbarH,
                    this.chartCursor
                ]);
        ...
        drawLabel: function(a) {
            if (this.container && !1 !== a.enabled) {
                ...
                0 !== g && c.rotate(g);
                a.url
                    ? (c.setAttr("cursor", "pointer"), c.click(function() { d.getURL(a.url) }))
        ...
        addListeners: function() {
            ...
            document.addEventListener
                ? (a.panEventsEnabled && (b.style.msTouchAction = "none"), "ontouchstart" in document.documentElement &&
                    (b.addEventListener("touchstart", function(b) { a.handleTouchStart.call(a, b) }, !0),
                        b.addEventListener("touchmove", function(b) { a.handleMouseMove.call(a, b) }, !0),
                        b.addEventListener("touchend", function(b) { a.handleTouchEnd.call(a, b) }, !0), document
                            .addEventListener("touchstart",
                                function(b) { a.handleDocTouchStart.call(a, b) }), document.addEventListener("touchend",
                            function(b) { a.handleDocTouchEnd.call(a, b) })), b.addEventListener("mousedown",
                        function(b) {
                            a.mouseIsOver = !0;
                            a.handleMouseMove.call(a, b);
                            a.handleMouseDown.call(a, b)
                        },
                        !0), b.addEventListener("mouseover", function(b) { a.handleMouseOver.call(a, b) }, !0),
                    b.addEventListener("mouseout", function(b) { a.handleMouseOut.call(a, b) }, !0))
                : (b.attachEvent("onmousedown", function(b) { a.handleMouseDown.call(a, b) }), b.attachEvent(
                    "onmouseover",
                    function(b) {
                        a.handleMouseOver.call(a,
                            b)
                    }), b.attachEvent("onmouseout", function(b) { a.handleMouseOut.call(a, b) }))
        },
        dispDUpd: function() {
            if (!this.skipEvents) {
                var a;
        ...
        showBalloonReal: function(a, b, c, e, d) {
            ...
            var f = this.balloon;
            f.enabled &&
            (f.followCursor(!1), f.changeColor(b), !c || f.fixedPosition
                ? (f.setPosition(e, d), isNaN(e) || isNaN(d) ? f.followCursor(!0) : f.followCursor(!1))
        ...
        handleMouseMove: function(a) {
            ...
            if (a) {
                ...
                this.boundingRect &&
                    a.clientX &&
                    (this.mouseX = a.clientX - this.boundingRect.left, this.mouseY = a.clientY - this.boundingRect.top)
            }
        },
            ...
            if (this.animations)
                for (a = this.animations.length - 1; 0 <= a; a--) {
                    ...
                    if (e <= c) {
                        ...
                        0 === k
                            ? (this.animations.splice(a, 1), h.node.style[f] = Number(b.to) + b.suffix)
        ...
        brr: function() {
            ...
            if (c != a || !0 === this.inIframe()) {
                ...
                if ("serial" == g || "xy" == g || "gantt" == g)
                    c = this.marginLeftReal, e = this.marginTopReal, d = c + this.plotAreaWidth, f =
                        e + this.plotAreaHeight;
                var g = a + "/javascript-charts/", k = "JavaScript charts", l = "JS chart by amCharts";
                "ammap" == this.product &&
                (g = a + "/javascript-maps/", k = "Interactive JavaScript maps",
...
(function() {
    ...
    d.AmGraph = d.Class({
        construct: function(a) {
            this.cname = "AmGraph";
            this.createEvents("rollOverGraphItem",
                "rollOutGraphItem",
                "clickGraphItem",
        ...
        draw: function() {
            ...
            e ||
            (h = this.valueAxis.stackType, e =
                "top", "column" == this.type &&
                (a.rotate && (e = "right"), "100%" == h || "regular" == h) &&
                (e = "middle"), this.labelPosition = e);
            d.ifArray(this.data) &&
            (a = !1, "xy" == b
                ? this.xAxis.axisCreated && this.yAxis.axisCreated && (a = !0)
                : this.valueAxis.axisCreated && (a = !0), !this.hidden && a && this.createGraph())
        },
        createGraph: function() {
            ...
            if (!isNaN(a.valueAxis.min) && !isNaN(a.valueAxis.max)) {
                ...
                case "serial":
                    a.categoryAxis &&
                    (a.createSerialGraph(), "candlestick" ==
                        a.type &&
        ...
        createRadarGraph: function() {
            ...
            for (m = this.start; m <= this.end; m++) {
                ...
                "none" == a ||
                    ...
                    a
                    ? p = n.values.value
                    : (p = n.values.close, q = n.values.open);
                if (isNaN(p)) this.connect || (this.drawLineGraph(b, c, e, d), b = [], c = [], e = [], d = []);
                    ...
                    n.y = r;
                    if (x = this.labelText)
                        n = this.createLabel(n, p, r, x), this.positionLabel(p, r, n, t), this.allBullets.push(n);
                    isNaN(f) && (f = p);
                    isNaN(g) && (g = r)
                }
            }
        ...
        positionLabel: function(a, b, c, e) {
            ...
            if (e) {
                ...
                !this.showAllValueLabels &&
                    r &&
                    f &&
                    (k.height > l.columnHeight || k.width > l.columnWidth) &&
                    (c.remove(), c = !1);
        ...
        createSerialGraph: function() {
            ...
            if (!(Q ||
                ...
                (1 == e.length &&
                    "step" != g &&
                    "none" == this.bullet &&
                    (this.bullet = "round", this.resetBullet = !0), !Ka && void 0 == Da || m))) {
                var Sa = Ra;
                Sa > f.max && (Sa = f.max);
                Sa < f.min && (Sa = f.min);
                ...
                r
                    ? (ga = p, Ja = Math.abs(Kb - Ga) + 1, rb = p, sb = Math.abs(gb - Ga) + 1, fb = qb =
                        0, f.reversed ? (Z = 0, eb = Ga) : (Z = Ga, eb = 0))
                    : (Ja = n, ga = Math.abs(Kb - Ga) + 1, sb = n, rb = Math.abs(gb - Ga) + 1,
            ...
            for (K = W; K <= ea; K++) {
                ...
                if (m && void 0 == this.openField)
                    for (var wb = K + 1;
                        wb < e.length &&
                        (!e[wb] ||
                            !(Za = e[K + 1].axes[f.id].graphs[b]) ||
                            !Za.values ||
                            (Na = Za.values.value, isNaN(Na)));
                        wb++);
                var R,
                    P,
                    M,
                ...
                if (Ca) {
                    ...
                    if ("candlestick" == g || "ohlc" == g)
                        Y = Ca.close, yb = Ca.low, Ea = f.getCoordinate(yb), xb = Ca.high, Fa = f.getCoordinate(xb);
                    na = Ca.open;
                    F = f.getCoordinate(Y);
                    isNaN(na) || (N = f.getCoordinate(na), m && (Na = na, na = N = NaN));
                    m &&
                    (void 0 == this.openField
                        ? Za && (Za.isNegative = Na < Y ? !0 : !1, isNaN(Na) && (y.isNegative = !Ma))
                        : y.isNegative = Na > Y ? !0 : !1);
                    if (!Q)
                    ...
                    "start" == this.pointPosition &&
                        (ma -= X / 2 + Math.floor(Ua * X / 2), ra = 0, Aa = Math.floor(X) + Math.floor(Ua * X));
                    "end" == this.pointPosition &&
                        (ma += X / 2 + Math.floor(Ua * X / 2), ra = Math.floor(X) + Math.floor(Ua * X), Aa = 0);
                    if (Mb) {
                    ...
                    ma > n + 1E5 && (ma = n + 1E5);
                    r
                        ? (G = F, O = N, N = F = ma, isNaN(na) && !this.fillToGraph && (O = ka), Oa = Ea, Pa = Fa)
                        : (O = G = ma, isNaN(na) && !this.fillToGraph && (N = ka));
                    if (!zb && Y < na || zb && Y < ta)
                        y.isNegative = !0, Ka && (Ia = Ka), Xa && (Ta = Xa), void 0 != Da &&
                            (Ba = Da);
                    Ya = !1;
                    isNaN(Y) ||
                    (m
                    ...
                    case "line":
                        if (isNaN(Y)) x || (this.drawLineGraph(A, w, T, U), A = [], w = [], T = [], U = []);
                            ...
                            if (Ya ||
                                ...
                                void 0 != y.fillColors ||
                                !isNaN(y.dashLength))
                                this.drawLineGraph(A, w, T, U), A = [G], w = [F], T = [], U =
                                        [], !La || isNaN(N) || isNaN(O) || (T.push(O), U.push(N)), m
                                        ? Ma
                                        ? (this.lineColorSwitched = sa, this.fillColorsSwitched = tb)
                                        : (this.lineColorSwitched = Da, this.fillColorsSwitched = Ka)
                                        : (this.lineColorSwitched = y.lineColor, this.fillColorsSwitched =
                                            y.fillColors),
                                    this.dashLengthSwitched = y.dashLength;
                    ...
                    case "smoothedLine":
                        if (isNaN(Y)) x || (this.drawSmoothedGraph(A, w, T, U), A = [], w = [], T = [], U = []);
                            ...
                            if (Math.abs(G -
                                    hb) >=
                                jb ||
                                Math.abs(F - ib) >= jb) A.push(G), w.push(F), hb = G, ib = F;
                            ua = G;
                            va = F;
                            ia = G;
                            ja = F;
                            !La || isNaN(N) || isNaN(O) || (T.push(O), U.push(N));
                            void 0 == y.lineColor && void 0 == y.fillColors && isNaN(y.dashLength) ||
                            (this.drawSmoothedGraph(A, w, T, U), A = [G], w = [F], T = [], U =
                                [], !La || isNaN(N) || isNaN(O) || (T.push(O), U.push(N)), this.lineColorSwitched =
                                y.lineColor, this.fillColorsSwitched = y.fillColors, this.dashLengthSwitched =
                                y.dashLength);
                    ...
                    case "step":
                        if (!isNaN(Y)) {
                            r
                                ? (isNaN(v) ||
                                        (A.push(v), w.push(F - ra)), w.push(F - ra), A.push(G), w.push(F + Aa), A.push(
                                        G),
                                    !La ||
                                        isNaN(N) ||
                                        isNaN(O) ||
                                        (isNaN(B) || (T.push(B), U.push(N - ra)), T.push(O), U.push(N - ra), T.push(O),
                                            U
                                                .push(N + Aa)))
                                : (isNaN(z) || (w.push(z), A.push(G - ra)), A.push(G - ra), w.push(F), A.push(G + Aa),
                                    w.push(F), !La ||
                                        isNaN(N) ||
                                        isNaN(O) ||
                                        (isNaN(D) || (T.push(O - ra), U.push(D)), T.push(O - ra), U.push(N), T.push(
                                            O + Aa), U.push(N)));
                            v = G;
                            z = F;
                            B = O;
                    ...
                    case "column":
                        ...
                        if (!isNaN(Y)) {
                            ...
                            if (!(Y < Ob && na < Ob || Y > Pb && na > Pb)) {
                                ...
                                if (r) {
                                    "3d" == I
                                        ? (P = F - (t / 2 - this.depthCount + 1) * (k + S) + S / 2 + J * ca, R =
                                            O + H * ca, xa = ca)
                                        : (P = Math.floor(F - (t / 2 - ca) * (k + S) + S / 2), R = O, xa = 0);
                                    M = k;
                                    ua = G;
                                    va = P + k / 2;
                                    ...
                                    isNaN(E.percentWidthValue) ||
                                        (M = this.height * E.percentWidthValue / 100, P = vb, vb += M, va = P + M / 2);
                                    P < p &&
                                        0 < M &&
                                        (pa = new d.Cuboid(h,
                                            ha,
                                            ...
                                            $a,
                                            kb,
                                            oa), y.columnWidth = Math.abs(ha), y.columnHeight = Math.abs(M))
                                } else {
                                    "3d" == I
                                        ? (R = G - (t / 2 - this.depthCount + 1) * (k + S) + S / 2 + H * ca, P =
                                            N + J * ca, xa = ca)
                                        : (R = G - (t / 2 - ca) * (k + S) + S / 2, P = N, xa = 0);
                                    M = k;
                                    ua = R + k / 2;
                                    va = F;
                                    ...
                                    isNaN(E.percentWidthValue) ||
                                        (M = this.width * E.percentWidthValue / 100, R = ub, ub += M, ua = R + M / 2);
                                    R < n + ca * H &&
                                        0 < M &&
                                        (this.showOnAxis && (P -= J / 2), pa =
                                            new d.Cuboid(h,
                                                M,
                                                ha,
                                                H - a.d3x,
                                                ...
                                                $a,
                                                kb,
                                                oa), y.columnHeight = Math.abs(ha), y.columnWidth = Math.abs(M))
                                }
                            }
                            if (pa &&
                            (za = pa.set, d.setCN(a, pa.set, "graph-" + this.type), d.setCN(a,
                                pa.set,
                                "graph-" + this.id), y.className &&
                                d.setCN(a, pa.set, y.className, !0), y.columnGraphics =
                                za, za.translate(R, P), this.columnsSet.push(za), (y.url || this.showHandOnHover) &&
                                za.setAttr("cursor", "pointer"), !Q)) {
                                "none" == I && (L = r ? (this.end + 1 - K) * C - c : C * K + c);
                                "3d" == I &&
                                (r
                                    ? (L =
                                            (this.end + 1 - K) * C - c - 1E3 * this.depthCount, ua += H *
                                            this.columnIndex,
                                        ia += H * this.columnIndex, y.y += H * this.columnIndex)
                                    : (L =
                                        (C - c) * (K + 1) + 1E3 * this.depthCount, va += J * this.columnIndex, ja += J *
                                        this.columnIndex, y.y += J * this.columnIndex));
                                if ("regular" == I || "100%" == I)
                                    L = r
                                        ? 0 < Ca.value
                                        ? (this.end + 1 - K) * C + c
                    ...
                    case "candlestick":
                        if (!isNaN(na) && !isNaN(Y)) {
                            ...
                            if (r) {
                                if (P = F - k / 2, R = O, M =
                                    k, P + M > p && (M = p - P), 0 > P && (M += P, P = 0), P < p && 0 < M) {
                                    var Bb, Cb;
                                    ...
                                    !isNaN(Pa) &&
                                        ...
                                        F < p &&
                                        0 < F &&
                                        (Va = d.line(h, Bb, [F, F], wa, V, aa), ab = d.line(h, Cb, [F, F], wa, V, aa));
                                    ha = G - O;
                                    pa = new d.Cuboid(h, ha, M, H, J, Ia, Wa, aa, wa, V, fa, u, r, ba, $a, kb, oa)
                                }
                            } else if (R = G - k / 2, P = N + aa / 2, M =
                                k, R + M > n && (M = n - R), 0 > R && (M += R, R = 0), ha = F - N, R < n && 0 < M) {
                                zb && Y >= na && (Ta = 0);
                                ...
                                !isNaN(Fa) &&
                                    ...
                                    G < n &&
                                    0 < G &&
                                    (Va = d.line(h, [G, G], Db, wa, V, aa), ab =
                                            d.line(h, [G, G], Eb, wa, V, aa), d.setCN(a, Va, this.bcn + "line-high"),
                                        y.className && d.setCN(a, Va, y.className, !0), d.setCN(a,
                                            ab,
                                            this.bcn + "line-low"), y
                                            .className &&
                            ...
                            pa &&
                            (za = pa.set, y.columnGraphics =
                                    za, da.push(za), za.translate(R, P - aa / 2),
                                (y.url || this.showHandOnHover) && za.setAttr("cursor", "pointer"),
                                Va && (da.push(Va), da.push(ab)), ua = G, va =
                                    F, r
                                    ? (ja = F, ia =
                                        G, "open" == l && (ia = O), "high" == l && (ia = Pa), "low" == l && (ia = Oa))
                                    : (ja =
                                        F, "open" == l && (ja = N), "high" == l && (ja = Fa), "low" == l && (ja = Ea),
                                    ia =
                                        G), Q ||
                                (y.x = r ? P + M / 2 : R + M / 2, this.animateColumns(pa, K, G, O, F, N), this
                                    .addListeners(za, y)))
                        }
                        break;
                    case "ohlc":
                        ...
                        if (this.end - this.start <= Tb || 0 === Tb) {
                            ...
                            if ("regular" == I || "100%" == I) {
                                ...
                                if (Wb) {
                                    ...
                                    r
                                        ? (cb = va, bb = 0 > Y ? G - Yb / 2 - 2 - db - pb : G + Yb / 2 + 3 + db + pb)
                                        : (bb = ua, cb = 0 > Y ? F + Zb / 2 + db + pb : F - Zb / 2 - 3 - db - pb);
                                    Qa.translate(bb,
                                        cb);
                                    f.totals[K] = Qa;
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g)
                "smoothedLine" == g ? this.drawSmoothedGraph(A, w, T, U) : this.drawLineGraph(A, w, T, U), Q ||
                    this.launchAnimation();
        ...
        animateColumns: function(a, b) {
            ...
            0 < e &&
                !c.animationPlayed &&
                (c.seqAn
                    ? (a.set.hide(), c.animationArray.push(a), e = setTimeout(function() { c.animate.call(c) },
                        e /
                        (c.end -
                            c.start +
                            1) *
                        (b - c.start) *
                        1E3), c.timeOuts.push(e))
                    : c.animate(a))
        },
        ...
        drawLineGraph: function(a, b, c, e) {
            ...
            if (1 < a.length) {
                ...
                var u = h.negativeLineColor,
                    ...
                    v = h.baseCoord;
                0 !== h.negativeBase &&
                    (v = h.valueAxis.getCoordinate(h.negativeBase), v > h.height && (v = h.height), 0 > v && (v = 0));
                n = d.line(k, a, b, q, n, p, x, !1, !0);
                d.setCN(g, n, h.bcn + "stroke");
                l.push(n);
                l.click(function(a) { h.handleGraphEvent(a, "clickGraph") })
                    .mouseover(function(a) { h.handleGraphEvent(a, "rollOverGraph") }).mouseout(function(a) {
                        h.handleGraphEvent(a, "rollOutGraph")
                    });
                void 0 === u ||
                    h.useNegativeColorIfDown ||
                    (p = d.line(k, a, b, u, r, p, x, !1, !0), d.setCN(g, p, h.bcn + "stroke"),
                        d.setCN(g, p, h.bcn + "stroke-negative"), m.push(p));
                if (0 < f || 0 < w)
                    if (p = a.join(";").split(";"), r = b.join(";").split(";"), n =
                        g.type, "serial" == n || "radar" == n
                        ? 0 < c.length
                        ? (c.reverse(), e.reverse(), p = a.concat(c), r = b.concat(e))
                        : "radar" == n
                        ? (r.push(0), p.push(0))
                        : h.rotate
                        ? (r.push(r[r.length - 1]), p.push(v), r.push(r[0]), p.push(v), r.push(r[0]), p.push(p[0]))
                        : (p.push(p[p.length - 1]), r.push(v), p.push(p[0]), r.push(v), p.push(a[0]), r.push(r[0]))
                        : "xy" == n &&
                        (b = h.fillToAxis) &&
                        (d.isString(b) && (b = g.getValueAxisById(b)), "H" == b.orientation
                            ? (v =
                                    "top" == b.position ? 0 : b.viH, p.push(p[p.length - 1]), r.push(v), p.push(p[0]),
                                r.push(v), p.push(a[0]), r.push(r[0]))
                            : (v =
                                    "left" == b.position ? 0 : b.viW, r.push(r[r.length - 1]), p.push(v), r.push(r[0]),
                                p.push(v), r.push(r[0]), p.push(p[0]))), a =
                        h.gradientRotation, 0 < f &&
                    (b = d.polygon(k, p, r, t, f, 1, "#000", 0, a), b.pattern(h.pattern, NaN, g.path), d.setCN(g,
                        b,
                        h.bcn + "fill"), l.push(b)), A || void 0 !== u)
                        isNaN(w) && (w = f), A || (A = u), k =
                            d.polygon(k, p, r, A, w, 1, "#000", 0, a), d.setCN(g, k, h.bcn + "fill"), d.setCN(g,
                            k,
                            h.bcn + "fill-negative"), k.pattern(h.pattern,
                            NaN,
                            g.path), m.push(k), m.click(function(a) { h.handleGraphEvent(a, "clickGraph") })
                            .mouseover(function(a) { h.handleGraphEvent(a, "rollOverGraph") }).mouseout(function(a) {
                                h.handleGraphEvent(a, "rollOutGraph")
                            });
                h.applyMask(m, l)
        ...
        drawSmoothedGraph: function(a, b, c, e) {
            if (1 < a.length) {
                ...
                k.push(m.path);
                void 0 !== t &&
                (n = new d.Bezier(g, a, b, t, w, n, r, 0, h), d.setCN(f, n, this.bcn + "stroke"), d.setCN(f,
                    n,
                    this.bcn + "stroke-negative"), l.push(n.path));
                0 < p &&
                    (m = a.join(";").split(";"), q = b.join(";").split(";"), n =
                            "", 0 < c.length
                            ? (c.push("M"), e.push("M"), c.reverse(), e.reverse(), m = a.concat(c), q = b.concat(e))
                            : (this.rotate
                                ? (n += " L" + A + "," + b[b.length - 1], n += " L" + A + "," + b[0])
                                : (n += " L" + a[a.length - 1] + "," + A, n += " L" + a[0] + "," + A), n += " L" +
                                a[0] +
                                "," +
                                b[0]), c =
                            new d.Bezier(g, m, q, NaN, 0, 0, r, p, h, n), d.setCN(f, c, this.bcn + "fill"),
                        c.path.pattern(this.pattern, NaN, f.path), k.push(c.path), u || void 0 !== t) &&
                    (x || (x = p), u || (u = t), a = new d.Bezier(g, a, b, NaN, 0, 0, u, x, h, n), a.path.pattern(
                            this.pattern,
                            NaN,
                            f.path), d.setCN(f, a, this.bcn + "fill"), d.setCN(f, a, this.bcn + "fill-negative"),
                        l.push(a.path)
                    );
                this.applyMask(l, k)
            }
        ...
        launchAnimation: function() {
            ...
            if (0 < b && !a.animationPlayed) {
                ...
                e.hide();
                a.seqAn
                    ? (b = setTimeout(function() { a.animateGraphs.call(a) }, a.index * b * 1E3), a.timeOuts.push(b))
                    : a.animateGraphs()
            }
        },
        animateGraphs: function() {
            ...
            (this.rotate
                    ...
                    : (b.translate(e, -1E3), c.translate(e, -1E3)), b.animate({ opacity: 1, translate: e + "," + d },
                    f,
                    a),
                c.animate({ opacity: 1, translate: e + "," + d }, f, a))
        },
        animate: function(a) {
        ...
        legendKeyColor: function() {
            var a =
                ...
                b = this.lineAlpha;
            void 0 === a &&
                (a = this.lineColorR, 0 === b && (b = this.fillColorsR) && (a = "object" == typeof b ? b[0] : b));
            return a
        },
        legendKeyAlpha: function() {
            var a = this.legendAlpha;
            void 0 === a &&
            (a = this.lineAlpha, this.fillAlphas > a && (a = this.fillAlphas), 0 === a && (a = this.bulletAlpha),
                0 === a && (a = 1));
            return a
        },
        createBullet: function(a, b, c) {
            if (!isNaN(b) && !isNaN(c)) {
                ...
                this.useLineColorForBulletBorder &&
                    (m = this.lineColorR, this.lineColorSwitched && (m = this.lineColorSwitched));
                var u = a.alpha;
                isNaN(u) || (t = u);
                if ("none" != this.bullet || a.bullet) q = d.bullet(h, f, g, p, t, k, m, n, l, 0, r, e.path);
                if (this.customBullet || a.customBullet)
                    r =
                        this.customBullet, a.customBullet && (r = a.customBullet), r &&
                    (q && q.remove(), "function" == typeof r
                        ? (r = new r, r.chart =
                                e, a.bulletConfig &&
                            (r.availableSpace = c, r.graph = this, r.graphDataItem = a, r.bulletY =
                                c, a.bulletConfig.minCoord = this.minCoord - c, r.bulletConfig = a.bulletConfig),
                            r.write(h), q && r.showBullet && r.set.push(q), a.customBulletGraphics = r.cset, q = r.set)
                        : (q = h.set(), h =
                            h.image(r, 0, 0, g, g), q.push(h), this.centerCustomBullets &&
                            h.translate(-g / 2, -g / 2)));
                if (q) {
        ...
        addListeners: function(a, b) {
            ...
            a.mouseover(function(a) {
                    c.handleRollOver(b,
                        a)
                }).mouseout(function(a) { c.handleRollOut(b, a) }).touchend(function(a) {
                    c.handleRollOver(b, a);
                    c.chart.panEventsEnabled && c.handleClick(b, a)
                }).touchstart(function(a) { c.handleRollOver(b, a) }).click(function(a) { c.handleClick(b, a) })
                .dblclick(function(a) { c.handleDoubleClick(b, a) })
                .contextmenu(function(a) { c.handleRightClick(b, a) })
        },
        handleRollOver: function(a, b) {
            if (a) {
                ...
                e = this.showBalloon;
                !c.chartCursor ||
                    "serial" != c.type && "gantt" != c.type ||
                    (e = !1, !c.chartCursor.valueBalloonsEnabled && this.showBalloon && (e = !0));
                if (e) {
                    ...
                    "" !== e
                        ? c.showBalloon(e, h, !0, f + c.marginLeftReal, g + c.marginTopReal)
...
(function() {
    ...
    d.ChartCursor = d.Class({
        ...
        draw: function() {
            ...
            this.valueLineBalloonEnabled &&
            (this.vaBalloon = c = new d.AmBalloon, d.copyProperties(b, c), c.animationDuration =
                0, this.rotate || (c.pointerOrientation = "H"));
            ...
            if (this.valueBalloonsEnabled)
                for (b = 0; b < a.graphs.length; b++)
                    c = new d.AmBalloon, c.className = a.graphs[b].id, c.chart =
                        a, d.copyProperties(a.balloon, c), a.graphs[b].valueBalloon = c;
        ...
        createCursor: function() {
            ...
            n
                ? (h = [0, l, l + g], f = [0, 0, k], g = [g, 0, 0], k = [k, 0, m])
                : (h = [g, 0, 0], f = [k, 0, m], g = [0, l, l + g], k = [0, 0, k]);
            ...
            (h = this.valueLineAlpha, isNaN(h) || (b = h), b =
                d.line(this.container, g, k, this.cursorColor, b, 1), b.node.style.pointerEvents =
                "none", d.setCN(a, b, "cursor-value-line"), this.vLine = b, this.set.push(b));
        ...
        update: function() {
            ...
            if (a)
                if (a.mouseIsOver) {
                    ...
                    -.5 < b && b < this.width + 1 && 0 < c && c < this.height
                        ? ((this.valueLineEnabled || this.valueLineBalloonEnabled) && this.updateVLine(b, c),
                            this.setPosition(), this.drawing
                                ? this.rolledOver || a.setMouseCursor("crosshair")
                                : this.pan && (this.rolledOver || a.setMouseCursor("move")), this.rolledOver = !0)
        ...
        updateVLine: function(a, b) {
            ...
            if ((c || e) && !this.panning && !this.drawing) {
                ...
                g
                    ? (c && c.translate(a, 0), d && (f = d.coordinateToValue(a)), c = a)
                    : (c && c.translate(0, b), d && (f = d.coordinateToValue(b)), c = b - 1);
                if (e &&
                    !isNaN(f) &&
                    this.prevLineValue !=
                    f) {
        ...
        updateCrosshair: function() {
            ...
            e &&
                ...
                (e.show(), h.show(), e.translate(b,
                    0), h.translate(0, c));
            this.zooming &&
                (a.hideXScrollbar && (b = NaN), a.hideYScrollbar && (c = NaN), this.updateSelectionSize(b, c));
            this.fireMoved();
        ...
        updateSelectionSize: function(a, b) {
            ...
            isNaN(a) ||
            (c > a &&
                (h = a, g = c - a), c < a && (h = c, g = a - c), c == a && (h = a, g = 0), g += this.extraWidth, h -=
                this.extraWidth / 2);
            isNaN(b) ||
            (e > b && (f = b, k = e - b), e < b && (f = e, k = b - e), e == b && (f = b, k = 0), k +=
                this.extraWidth, f -= this.extraWidth / 2);
            0 < g &&
                0 < k &&
                (c = d.rect(this.container, g, k, this.cursorColor, this.selectionAlpha), d.setCN(this.chart,
                    c,
                    "cursor-selection"), c.translate(h + this.x, f + this.y), this.selection = c)
        },
        ...
        arrangeBalloons2: function() {
            ...
            for (d = 0; d < f; d++) {
                ...
                0 < d &&
                    b - k < e + 3 &&
                    (g.setBounds(c, e + 3, c + this.width, e + k + 3), g.prevX = this.prevX[l], g.prevY =
                            this.prevY[l], g.prevTX = this.prevTX[l],
        ...
        zoom: function(a, b, c, e) {
            ...
            if (this.fullWidth) {
                ...
                this.line = d.rect(this.container,
                    b,
                    c,
                    this.cursorColor,
                    this.cursorAlpha,
        ...
        hideCursor: function(a) {
            void 0 === a && (a = !0);
            this.leaveCursor ||
            (this.hideObj(this.set), this.hideObj(this.categoryBalloon), this.hideObj(this.line), this.hideObj(
                    this.vLine),
                this.hideObj(this.hLine), this.hideObj(this.vaBalloon), this.hideObj(this.allBullets),
                this.destroyValueBalloons(), this.selectWithoutZooming || d.remove(this.selection), this.previousIndex =
                    NaN, a && this.fire("onHideCursor", { type: "onHideCursor", chart: this.chart, target: this }),
                    ...
                    isNaN(a) && (a = this.getMousePosition()),
                        (a != this.previousMousePosition || !0 === this.zoomed || this.oneBalloonOnly) &&
                            ...
                            ("mouse" == this.cursorPosition && (this.tempPosition = a),
                                isNaN(c) && (c = this.chart.categoryAxis.xToIndex(a)), c != this.previousIndex ||
                                    this.zoomed ||
                                    "mouse" == this.cursorPosition ||
                                    this.oneBalloonOnly) &&
                            (this.updateCursor(c, b, e), this.zoomed = !1), this.previousMousePosition = a
        ...
        normalizeBulletSize: function() {
            ...
            if (a)
                for (var b = 0; b < a.length; b++) {
                    ...
                    (e.translate(c.bx,
                        c.by,
                        1), c = c.graph, isNaN(this.graphBulletAlpha) ||
                        (e.setAttr("fill-opacity", c.bulletAlpha), e.setAttr("stroke-opacity", c.bulletBorderAlpha)))
                }
        },
        updateCursor: function(a, b, c) {
            var e = this.chart, h = this.fullWidth, f = e.mouseX - this.x, g = e.mouseY - this.y;
            this.drawingNow &&
            (d.remove(this.drawingLine), this.drawingLine = d.line(this.container,
                [this.x + this.drawStartX, this.x + f],
                [this.y + this.drawStartY, this.y + g],
                this.cursorColor,
                1,
                1));
            if (this.enabled) {
                ...
                if (t) {
                    ...
                    if (e.mouseIsOver || C || L || this.forceShow)
                        if (this.forceShow = !1, L) {
                            ...
                            0 !== f &&
                            (b = { type: "zoomed", target: this }, b.chart =
                                this.chart, k.parseDates && !k.equalSpacing
                                ? (a + f > B && (f = B - a), e + f < z && (f = z - e), b.start =
                                    Math.round(e + f), b.end = Math.round(a + f), this.fire(b.type, b))
                                : C + f >= this.data.length ||
                                0 > J + f ||
                                (b.start = J + f, b.end = C + f, this.fire(b.type, b)))
                        } else {
                            "start" == D
                                ? x -= k.cellWidth / 2
                                : "mouse" == D &&
                                (e.mouseIsOver
                                    ? x = A ? g - 2 : f - 2
                                    : isNaN(this.tempPosition) || (x = this.tempPosition - 2));
                            if (A) {
                                if (0 > x)
                                    if (C) x = 0;
                                    else {
                            ...
                            0 < this.cursorAlpha &&
                            (A
                                ? (B = 0, w = x + m, h && (w -= k.cellWidth / 2))
                                : (B = x, w = 0, h && (B -= k.cellWidth / 2)), D =
                                this.animationDuration, 0 < D && !this.zooming
                                ? isNaN(this.previousX)
                                ? z.translate(B, w)
                                : (z.translate(this.previousX, this.previousY), z.animate({ translate: B + "," + w },
                                    D,
                                    "easeOutSine"))
                                : z.translate(B, w), this.previousX = B, this.previousY = w, z.show());
                            this.linePos = A ? x + m : x;
                            C &&
                            (h && z.hide(), A
                                ? this.updateSelectionSize(NaN,
                                    x)
                                : this.updateSelectionSize(x, NaN));
                            B = !0;
                            C && (B = !1);
                            this.categoryBalloonEnabled && B
                                ? (this.setBalloonPosition(v, k, x, A), (z = this.categoryBalloonFunction)
                                    ? v.showBalloon(z(t.category))
                                    : (z = x = "", k.parseDates
                                            ? (x = d.formatDate(t.category, this.categoryBalloonDateFormat, e), k =
                                                    d.changeDate(new Date(t.category), e.categoryAxis.minPeriod, 1), z =
                                                    d.formatDate(k, this.categoryBalloonDateFormat, e),
                                                -1 != x.indexOf("fff") &&
                                                (x = d.formatMilliseconds(x, t.category), z =
                                                    d.formatMilliseconds(z, k)))
                                            : (x = d.fixNewLines(t.category), u && (z = d.fixNewLines(u.category))),
                                        k = this.categoryBalloonText.replace(/\[\[category\]\]/g, String(x)), k =
                                            k.replace(/\[\[toCategory\]\]/g, String(z)), v.showBalloon(k)))
                                : v.hide();
                            ...
                            if (this.oneBalloonOnly) {
                                ...
                                for (k = 0; k < H.length; k++)
                                    v = H[k], v.showBalloon &&
                                        !v.hidden &&
                                        v.balloonText &&
                                        (u = t.axes[v.valueAxis.id].graphs[v.id], z =
                                            u.y, "top" == v.showBalloonAt && (z = 0), "bottom" == v.showBalloonAt &&
                                            (z = this.height), isNaN(z) ||
                                        (A
                                            ? Math.abs(f - z) < x && (x = Math.abs(f - z), J = v)
                                            : Math.abs(g - z) < x && (x = Math.abs(g - z), J = v)));
                                this.mostCloseGraph &&
                                    (J = this.mostCloseGraph)
                            }
                            if (!c &&
                                (a != this.previousIndex || J != this.previousMostCloseGraph) &&
                                (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets =
                                    [], H && this.valueBalloonsEnabled && B && e.balloon.enabled)) {
                                this.valueBalloons = c = [];
                                for (k = 0; k < H.length; k++)
                                    if (v = H[k], z = NaN, (!this.oneBalloonOnly || v == J) &&
                                        v.showBalloon &&
                                        !v.hidden &&
                                        v.balloonText &&
                                        ("step" == v.type && "left" == v.stepDirection && (t = this.data[a + 1]), t)) {
                                        ...
                                        if (this.showNextAvailable && isNaN(z) && a + 1 < this.data.length)
                                            for (B = a + 1; B < this.data.length; B++)
                                                if (x = this.data[B])
                                                    if (u = x.axes[v.valueAxis.id].graphs[v.id], z =
                                                        u.y, !isNaN(z)) break;
                                        if (!isNaN(z)) {
                                            x = u.x;
                                            w = !0;
                                            ...
                                            w &&
                                            (w = this.graphBulletSize, h = this.graphBulletAlpha, 1 == w && isNaN(h) ||
                                                    !d.isModern ||
                                                    !(m = u.bulletGraphics) ||
                                                    (m.translate(u.bx, u.by, w), this.resizedBullets.push(u),
                                                        isNaN(h) ||
                                                        (m.setAttr("fill-opacity", h), m.setAttr("stroke-opacity",
                                                            h))), w = v.valueBalloon, h =
                                                    e.getBalloonColor(v, u), w.setBounds(n, p, n + q, p + r),
                                                w.pointerOrientation = "H", m =
                                                    this.balloonPointerOrientation,
                                                "vertical" == m && (w.pointerOrientation = "V"),
                                                "horizontal" == m && (w.pointerOrientation = "H"), w.changeColor(h),
                                                void 0 !== v.balloonAlpha && (w.fillAlpha = v.balloonAlpha),
                                                void 0 !== v.balloonTextColor && (w.color = v.balloonTextColor),
                                                w.setPosition(B + n, x + p), B =
                                                    e.formatString(v.balloonText, u, !0), (x = v.balloonFunction) &&
                                                    (B = x(u, v).toString()), "" !== B &&
                                                (A ? w.showBalloon(B) : (w.text = B, w.show = !0), c.push({
                                                    yy: z,
                                                    balloon: w
                                                })), !A &&
                                                    w.set &&
                                                    (w.set.hide(), v = w.textDiv) &&
                            ...
                            b
                                ? (b = { type: "changed" }, b.index = a, b.chart = this.chart, b.zooming =
                                    C, b.mostCloseGraph = J, b.position = A ? g : f, b.target =
                                    this, e.fire("changed", b), this.fire("changed", b), this.skipZoomDispatch = !1)
                                : (this.skipZoomDispatch = !0, e.updateLegendValues(a));
        ...
        setBalloonPosition: function(a, b, c, e) {
            ...
            e
                ? (f &&
                ("right" == d
                    ? a.setBounds(l, m + g, l + n + k, m + c + g)
                    : a.setBounds(l, m + g, l + n + k, m + c)), "right" == d
                    ? f
                    ? a.setPosition(l + n + k, m + c + g)
                    : a.setPosition(l + n + k + b, m + c + g)
                    : f
                    ? a.setPosition(l, m + c)
                    : a.setPosition(l - b, m + c))
                : "top" == d
                ? f
                ? a.setPosition(l + c + k, m + g)
                : a.setPosition(l + c + k, m + g - b + 1)
                : f
                ? a.setPosition(l + c, m + p)
                : a.setPosition(l + c, m + p + b - 1)
        },
        setBalloonBounds: function(a, b, c) {
            var e = b.position,
                ...
                q = this.height;
            c
                ? (d && (a.pointerWidth = 0), "right" == e
                    ? d
                    ? a.setBounds(m, n + k, m + p + l, n + q + k)
                    : a.setBounds(m + p + l + f, n + k, m + p + 1E3, n + q + k)
                    : d
                    ? a.setBounds(m, n, p + m, q + n)
                    : a.setBounds(-1E3, -1E3, m - g - f, n + q + 15))
                : (a.maxWidth = p, b.parseDates && (g = 0, a.pointerWidth = 0), "top" == e
                    ? d
                    ? a.setBounds(m + l, n + k, p + l + m, q + n)
                    : a.setBounds(m + l, -1E3, p + l + m, n + k - g - f)
                    : d
                    ? a.setBounds(m, n, p + m, q + n - g)
                    : a.setBounds(m, n + q + g + f - 1, m + p, n + q + g + f))
        },
            ...
            if (a) {
                ...
                if (this.enabled && 0 < b.length) {
                    if (this.pan) this.rolledOver = !1;
                        ...
                        c.chart = a;
                        if ("cursor" == this.type)
                            this.rotate ? this.selectionPosY = h : this.selectionPosX = h = e,
                                4 > Math.abs(h - this.initialMouse) && this.fromIndex == this.index ||
                                (this.index < this.fromIndex
                                    ? (c.end = this.fromIndex, c.start = this.index)
                                    : (c.end = this.index, c.start = this.fromIndex), h =
                                    a.categoryAxis, h.parseDates &&
                                    !h.equalSpacing &&
                                    (b[c.start] && (c.start = b[c.start].time), b[c.end] &&
                                        (c.end = a.getEndTime(b[c.end].time))), this.skipZoomDispatch ||
                                    this.fire(c.type, c));
                        else {
                            var g = this.initialMouseX, k = this.initialMouseY;
                            3 > Math.abs(e - g) && 3 > Math.abs(h - k) ||
                            (b = Math.min(g, e), f = Math.min(k,
                                    h), e = Math.abs(g - e), h =
                                    Math.abs(k - h), a.hideXScrollbar && (b = 0, e = this.width),
                                a.hideYScrollbar && (f = 0, h = this.height), c.selectionHeight = h, c.selectionWidth =
                                    e, c.selectionY = f, c.selectionX =
                                    b, this.skipZoomDispatch || this.fire(c.type, c))
                        }
        ...
        handleMouseDown: function(a) {
            if (this.zoomable || this.pan || this.drawing) {
                ...
                if (0 < e && e < this.width && 0 < h && h < this.height || "fake" == a)
                    this.setPosition(), this.selectWithoutZooming && d.remove(this.selection), this.drawing
                        ? (this.drawStartY = h, this.drawStartX = e, this.drawingNow = !0)
                        : this.pan
                        ? (this.zoomable = !1, c.setMouseCursor("move"), this.panning = !0, this.panClickPos =
                                b ? h : e, this.panClickStart = this.start,
                            this.panClickEnd = this.end, this.panClickStartTime = this.startTime, this.panClickEndTime =
                                this.endTime)
                        : this.zoomable &&
                        ("cursor" == this.type
                            ? (this.fromIndex =
                                this.index, b
                                ? (this.initialMouse = h, this.selectionPosY = this.linePos)
                                : (this.initialMouse = e, this.selectionPosX = this.linePos))
                            : (this.initialMouseX = e, this.initialMouseY = h, this.selectionPosX =
                                e, this.selectionPosY = h), this.zooming = !0)
            }
        }
    })
})();
    ...
    d.SimpleChartScrollbar = d.Class({
        ...
        draw: function() {
            ...
            if (a.enabled) {
                ...
                if ((a.height = g) && f) {
                    ...
                    a.dragger = f;
                    h.push(f);
                    f.mousedown(function(b) { a.handleDragStart(b) }).mouseup(function() { a.handleDragStop() })
                        .mouseover(function() { a.handleDraggerOver() }).mouseout(function() { a.handleMouseOut() })
                        .touchstart(function(b) { a.handleDragStart(b) }).touchend(function() { a.handleDragStop() });
                    f = e.pathToImages;
                    g = a.dragIcon.replace(/\.[a-z]*$/i, "");
                    c
                        ? (k = f + g + "H" + e.extension, f = a.dragIconWidth, c = a.dragIconHeight)
                        : (k = f + g + e.extension, c = a.dragIconWidth, f = a.dragIconHeight);
                    g = b.image(k, 0, 0, c, f);
                    ...
                    a.iconRight = b;
                    h.push(b);
                    c.mousedown(function() { a.leftDragStart() }).mouseup(function() { a.leftDragStop() })
                        .mouseover(function() { a.iconRollOver() }).mouseout(function() { a.iconRollOut() })
                        .touchstart(function() { a.leftDragStart() }).touchend(function() { a.leftDragStop() });
                    b.mousedown(function() { a.rightDragStart() }).mouseup(function() { a.rightDragStop() })
                        .mouseover(function() { a.iconRollOver() }).mouseout(function() { a.iconRollOut() })
                        .touchstart(function() { a.rightDragStart() }).touchend(function() { a.rightDragStop() });
        ...
        updateScrollbarSize: function(a, b) {
            ...
            this.rotate
                ...
                : (e = a, d = 0, f = b - a, g = this.height + 1, c.setAttr("width", b - a), c.setAttr("x", e));
        ...
        update: function() {
            ...
            if (k) {
                ...
                n.mouseIsOver &&
                (this.dragging &&
                    (n = this.initialCoord, m
                        ? (a = n + (t - a), 0 > a && (a = 0), n = q - k, a > n && (a = n), g.setAttr("y", a))
                        : (a = n + (r - a), 0 > a && (a = 0), n = p - l, a > n && (a = n), g.setAttr("x", a)), this
                        .clipDragger(!0)),
                    this.resizingRight &&
                    (m
                        ? (a = t - e, a + e > q + f && (a = q - e + f), 0 > a
                            ? (this.resizingRight = !1, b = this.resizingLeft = !0)
                            : (0 === a && (a = .1), g.setAttr("height", a)))
                        : (a = r - c, a + c > p + d && (a = p - c + d), 0 > a
                            ? (this.resizingRight = !1, b = this.resizingLeft = !0)
                            : (0 === a && (a = .1), g.setAttr("width", a))), this.clipDragger(!0)), this.resizingLeft &&
                    (m
                        ? (c = e, e = t, e < f && (e = f), e > q + f && (e = q + f), a =
                            !0 === b ? c - e : k + c - e, 0 > a
                            ? (this.resizingRight = !0, this.resizingLeft = !1, g.setAttr("y", c + k - f))
                            : (0 === a && (a = .1), g.setAttr("y", e - f), g.setAttr("height", a)))
                        : (e = r, e < d && (e = d), e > p + d && (e = p + d), a = !0 === b ? c - e : l + c - e, 0 > a
                            ? (this.resizingRight = !0, this.resizingLeft = !1, g.setAttr("x", c + l - d))
                            : (0 === a && (a = .1), g.setAttr("x", e - d), g.setAttr("width",
        ...
        updateDragIconPositions: function() {
            ...
            this.rotate
                ? (f = this.dragIconWidth, g =
                        this.dragIconHeight, e.translate((k - g) / 2, c - f / 2),
                    d.translate((k - g) / 2, c + a.height - f / 2))
                : (f = this.dragIconHeight, g =
                    this.dragIconWidth, e.translate(b - g / 2, (k - f) / 2), d.translate(b - g / 2 + a.width,
                    (k - f) / 2))
        },
        ...
        relativeZoom: function(a, b) {
            this.enabled &&
            (this.dragger.stop(), this.multiplier = a, this.position =
                    b, this.updateScrollbarSize(b, this.rotate ? b + this.height / a : b + this.width / a),
                this.clipDragger())
        },
        destroy: function() {
            this.clear();
        ...
        handleBgClick: function() {
            ...
            if (!a.resizingRight &&
                ...
                a.updateOnReleaseOnly
                    ...
                    : (c = Math.round(c), m ? h.animate({ y: c }, e, ">") : h.animate({ x: c }, e, ">"), a.forceClip =
                        !0, clearTimeout(a.forceTO), a.forceTO = setTimeout(function() { a.stopForceClip.call(a) },
                        5E3 * e))
            }
        },
    ...
    d.ChartScrollbar = d.Class({
        ...
        init: function() {
            ...
            if (a = this.graph) {
                ...
                c ||
                (this.valueAxis = c = new d.ValueAxis, c.visible = !1, c.scrollbar = !0, c.axisItemRenderer =
                    d.RecItem, c.axisRenderer = d.RecAxis, c.guideFillRenderer = d.RecFill, c.labelsEnabled =
                    !1, c.chart = b);
                b = this.unselectedGraph;
                b ||
                (b = new d.AmGraph, b.scrollbar = !0, this.unselectedGraph = b, b.negativeBase = a.negativeBase,
                    b.noStepRisers = a.noStepRisers);
                b = this.selectedGraph;
                b ||
                (b = new d.AmGraph, b.scrollbar = !0, this.selectedGraph = b, b.negativeBase =
                    a.negativeBase, b.noStepRisers = a.noStepRisers)
            }
        ...
        draw: function() {
            ...
            if (a.enabled) {
                ...
                if (m = a.graph) {
                    ...
                    u.zoom(0, c);
                    q.zoom(0, c);
                    q.set.click(function() { a.handleBackgroundClick() }).mouseover(function() { a.handleMouseOver() })
                        .mouseout(function() { a.handleMouseOut() });
                    u.set.click(function() { a.handleBackgroundClick() }).mouseover(function() { a.handleMouseOver() })
                        .mouseout(function() { a.handleMouseOut() });
                    n.push(u.set);
                    n.push(q.set)
                }
        ...
        dispatchScrollbarEvent: function() {
            if (this.skipEvent) this.skipEvent = !1;
                ...
                if (k.parseDates && !k.equalSpacing) {
                    if (a = g.lastTime, g = g.firstTime, k = Math.round(b / l) + g, b =
                            this.dragging ? k + this.timeDifference : Math.round((b + c) / l) + g, k > b && (k = b),
                        0 < d &&
                            b - k < d &&
                            (b = Math.round(k + (b - k) / 2), e = Math.round(d / 2), k = b - e, b += e, e = !0),
                        b > a && (b = a), b - d < k && (k = b - d), k < g && (k = g), k + d > b && (b = k + d),
                        k != this.startTime || b != this.endTime)
                        this.startTime =
                            k, this.endTime = b, f.start = k, f.end = b, f.startDate = new Date(k), f.endDate =
                            new Date(b), this.fire(f.type, f)
                } else if (k.startOnAxis || (b += l / 2), c -= this.stepWidth / 2, d = k.xToIndex(b), b =
                    k.xToIndex(b + c), d != this.start || this.end != b)
                    k.startOnAxis &&
                            (this.resizingRight && d == b && b++, this.resizingLeft && d == b && (0 < d ? d-- : b = 1)),
                        this.start = d, this.end = this.dragging ? this.start + this.difference : b, f.start =
                            this.start, f.end = this.end, k.parseDates &&
                        (a[this.start] && (f.startDate = new Date(a[this.start].time)), a[this.end] &&
        ...
        zoomScrollbar: function() {
            ...
            e.parseDates && !e.equalSpacing
                ? (c = e.stepWidth, e = a.firstTime, a = c * (this.startTime - e), b = c * (this.endTime - e))
                : (a = c[this.start].x[e.id], b = c[this.end].x[e.id], c =
                    e.stepWidth, e.startOnAxis || (e = c / 2, a -= e, b += e));
            this.stepWidth = c;
        ...
        handleBackgroundClick: function() {
            ...
            this.dragging ||
            (this.difference = this.end - this.start, this.timeDifference =
    ...
    d.AmBalloon = d.Class({
        ...
        draw: function() {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    n.innerHTML = '<div style="text-align:' +
                        this.textAlign +
                        "; " +
                        C +
                        "max-width:" +
                    ...
                    "H" != A
                        ? (D = a - C / 2, b < k + v + 10 && "down" != A
                            ? (L = !0, e && (b += z), z = b + x, this.deltaSignY = -1)
                            : (e && (b -= z), z = b - v - x, this.deltaSignY = 1))
                        : (2 * x > v && (x = v / 2), z = b - v / 2, a < g + (l - g) / 2
                            ? (D = a + x, this.deltaSignX = -1)
                            : (D = a - C - x, this.deltaSignX = 1));
                    z + v >= m && (z = m - v);
                    z < k && (z = k);
                    D < g && (D = g);
                    D + C > l && (D = l - C);
                    ...
                    0 < w || 0 === x
                        ? (0 < u &&
                            (a = d.rect(h,
                                ...
                                H,
                                u,
                                this.cornerRadius), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), p =
                                d.rect(h, C, v, p, this.fillAlpha, t, q, this.borderAlpha, this.cornerRadius),
                            this.showBullet && (I = d.circle(h, J, r, this.fillAlpha), f.push(I)))
                        : (r = [], w = [], "H" != A
                            ? (g = a - D, g > C - x && (g = C - x), g < x && (g = x), r =
                                [0, g - x, a - D, g + x, C, C, 0, 0], w =
                                L ? [0, 0, b - z, 0, 0, v, v, 0] : [v, v, b - z, v, v, 0, 0, v])
                            : (r = b - z, r > v - x && (r = v - x), r < x && (r = x), w =
                                [0, r - x, b - z, r + x, v, v, 0, 0], r = a < g + (l - g) / 2
                                ? [0, 0, D < a ? 0 : a - D, 0, 0, C, C, 0]
                                : [C, C, D + C > a ? C : a - D, C, C, 0, 0, C]), 0 < u &&
                        (a = d.polygon(h,
                            r,
                            w,
                            p,
                            ...
                            t,
                            H,
                            u), a.translate(1, 1), f.push(a)), p =
                            d.polygon(h, r, w, p, this.fillAlpha, t, q, this.borderAlpha));
                    this.bg = p;
                    f.push(p);
                    p.toFront();
                    ...
                    0 < this.animationDuration &&
                        !e &&
                        !isNaN(this.prevX) &&
                        (f.translate(this.prevX, this.prevY), f.animate({
                                translate: D -
                                    h +
                                    "," +
                                    z
                            ...
                            b,
                            "easeOutSine"), n &&
                        (B.left = this.prevTX + "px", B.top = this.prevTY + "px", this.xAnim =
                            c.animate({ node: n }, "left", this.prevTX, m, b, "easeOutSine", "px"), this.yAnim =
                            c.animate({ node: n }, "top", this.prevTY, k, b, "easeOutSine", "px")));
                    this.prevX = D - h;
                    this.prevY = z;
                    this.prevTX = m;
                    this.prevTY = k
        ...
        hide: function(a) {
            ...
            if (0 < a) {
                ...
                b.textDiv &&
                (b.fadeAnim2 = c.animate({ node: b.textDiv },
                    "opacity",
                    1,
                    0,
                    a,
        ...
        followCursor: function(a) {
            ...
            !isNaN(c) &&
                a &&
                (b.pointToX = c - b.offsetX * b.deltaSignX, b.pointToY = e, b.followMouse(),
                    b.interval = setInterval(function() { b.followMouse.call(b) }, 40))
        },
        removeDiv: function() {
            if (this.textDiv) {
    ...
    d.AmCoordinateChart = d.Class({
        ...
        parseSerialData: function(a) {
            ...
            if (a) {
                ...
                k &&
                (f = k.parseDates, l = k.forceShowField, n = k.classNameField, m = k.labelColorField, g =
                    k.categoryFunction);
                var p, q, r = {}, t;
                f &&
                (c = d.extractPeriod(k.minPeriod), p = c.period, q = c.count, t =
                ...
                for (x = 0; x < a.length; x++) {
                    ...
                    if (f &&
                    (k.categoryFunction
                        ? c = k.categoryFunction(c, z, k)
                        : (!A || c instanceof Date || (c = c.toString() + " |"), c = d.getDate(c, A, k.minPeriod)), c =
                        d.resetDateToMin(c, p, q, k.firstDayOfWeek), v.category = c, v.time =
                        c.getTime(), isNaN(v.time))) continue;
        ...
        processValues: function(a, b, c) {
            ...
            for (var g = "value error open close low high".split(" "), k = 0; k < g.length; k++) {
                ...
                var m = a[b[l + "Field"] + c];
                null !== m &&
                (h = Number(m), isNaN(h) || (e[l] = h), "date" == b.valueAxis.type &&
                    void 0 !== m &&
        ...
        parseGraphData: function(a) {
            ...
            for (e = 0; e < b.length; e++) {
                ...
                f &&
                (g = f.axes[g].graphs[a.id], g.serialDataItem = f, g.values =
                    this.processValues(d, a, a.periodValue), this.processFields(a, g, d))
            }
        },
        ...
        processGuides: function() {
            ...
            if (a)
                for (var c = 0; c < a.length; c++) {
                    ...
                    var h = e.valueAxis;
                    h
                        ? (d.isString(h) && (h = this.getValueAxisById(h)), h
                            ? h.addGuide(e)
                            : this.valueAxes[0].addGuide(e))
        ...
        formatString: function(a,
            ...
            h.duration &&
                b.values.value &&
                (h = d.formatDuration(b.values.value,
                    h.duration,
                    "",
                    h.durationUnits,
                    h.maxInterval,
                    h.numberFormatter), a = a.split("[[value]]").join(h));
        ...
        showGraph: function(a) {
            a.switchable &&
            (a.hidden = !1, this.dataChanged =
                !0, "xy" != this.type && (this.marginsUpdated = !1), this.chartCreated && this.initChart())
        },
        hideGraph: function(a) {
            a.switchable &&
            (this.dataChanged = !0, "xy" != this.type && (this.marginsUpdated = !1), a.hidden =
                !0, this.chartCreated && this.initChart())
        },
...
(function() {
    ...
    d.AmSlicedChart = d.Class({
        inherits: d.AmChart,
        construct: function(a) {
            this.createEvents("rollOverSlice",
                "rollOutSlice",
                "clickSlice",
                "pullOutSlice",
                "pullInSlice",
        ...
        initChart: function() {
            ...
            this.dataChanged &&
            (this.parseData(), this.dispatchDataUpdated = !0, this.dataChanged =
                !1, this.setLegendData(this.chartData));
            this.drawChart()
        },
        handleLegendEvent: function(a) {
        ...
        addEventListeners: function(a, b) {
            var c = this;
            a.mouseover(function(a) { c.rollOverSlice(b, !0, a) }).mouseout(function(a) { c.rollOutSlice(b, a) })
                .touchend(function(a) {
                    c.rollOverSlice(b,
                        a)
                }).touchstart(function(a) {}).mouseup(function(a) { c.clickSlice(b, a) })
                .contextmenu(function(a) { c.handleRightClick(b, a) })
        },
        ...
        startSlice: function(a) {
            ...
            b &&
                0 < c &&
                (0 < a.alpha && b.show(), b.translate(a.startX, a.startY), b.animate({ opacity: 1, translate: "0,0" },
                    c,
                    this.startEffect));
            e &&
                0 < c &&
                (0 < a.alpha && e.show(), e.translate(a.startX, a.startY), e.animate({ opacity: 1, translate: "0,0" },
                    c,
                    this.startEffect))
        },
        showLabels: function() {
        ...
        initialStart: function() {
            var a = this, b = a.startDuration, c = setTimeout(function() { a.showLabels.call(a) }, 1E3 * b);
            a.timeOuts.push(c);
            a.chartCreated
                ? a.pullSlices(!0)
                : (a.startSlices(), 0 < b
                    ? (b = setTimeout(function() { a.pullSlices.call(a) }, 1200 * b), a.timeOuts.push(b))
                    : a.pullSlices(!0))
        },
        pullSlice: function(a,
            ...
            if (c = a.wedge)
                0 < e
                    ? (c.animate({ translate: b * a.pullX + "," + b * a.pullY }, e, this.pullOutEffect), a.labelSet &&
                        a.labelSet.animate({ translate: b * a.pullX + "," + b * a.pullY }, e, this.pullOutEffect))
                    : (a.labelSet && a.labelSet.translate(b * a.pullX, b * a.pullY), c.translate(b * a.pullX,
                        b * a.pullY));
            1 == b
                ? (a.pulled = !0, this.pullOutOnlyOne && this.pullInAll(a.index), a =
                    { type: "pullOutSlice", dataItem: a, chart: this })
        ...
        parseData: function() {
            ...
            if (void 0 !== b) {
                ...
                1 < b &&
                (this.groupValue = 0, this.removeSmallSlices(), a.push({
                ...
                for (h = 0; h < a.length; h++)
                    c
                        ? g = d.adjustLuminosity(c, h * e / 100)
                        : (g = this.colors[h], void 0 === g && (g = d.randomColor())), void 0 === a[h].color &&
                        (a[h].color = g);
                this.recalculatePercents()
            }
        },
    ...
    d.AmRectangularChart = d.Class({
        ...
        resetMargins: function() {
            ...
            if ("xy" == this.type) {
                ...
                e = this.valueAxes;
                for (b = 0; b < e.length; b++)
                    c = e[b], c.ignoreAxisWidth ||
                        (c.setOrientation(this.rotate), c.fixAxisPosition(), a[c.position] = !0);
                (b = this.categoryAxis) &&
                    !b.ignoreAxisWidth &&
        ...
        measureMargins: function() {
            ...
            for (m = 0; m < a.length; m++)
                a[m].handleSynchronization(), b = this.getAxisBounds(a[m], g, l, k, b), g = Math.round(b.l), l =
                    Math.round(b.r), k = Math.round(b.t), b = Math.round(b.b);
            if (a = this.categoryAxis)
                b = this.getAxisBounds(a, g, l, k, b), g = Math.round(b.l), l = Math.round(b.r), k =
                    Math.round(b.t), b = Math.round(b.b);
            e.left && g < c && (this.marginLeft = Math.round(-g + c));
            e.right && l >= d - c && (this.marginRight = Math.round(l - d + c));
            e.top &&
                k < c + this.titleHeight &&
                (this.marginTop = Math.round(this.marginTop - k + c + this.titleHeight));
        ...
        drawZoomOutButton: function() {
            ...
            if (!a.zbSet) {
                ...
                m &&
                (m.fontSize && (e = m.fontSize), m.color && (c = m.color),
                    m.backgroundColor && (k = m.backgroundColor), isNaN(m.backgroundAlpha) ||
                        (a.zoomOutButtonRollOverAlpha = m.backgroundAlpha));
                var q = m = 0;
                void 0 !== a.pathToImages &&
                    f &&
                    (p = a.container.image(a.pathToImages + f + a.extension, 0, 0, h, h), d.setCN(a,
                        p,
                        "zoom-out-image"), b.push(p), p = p.getBBox(), m = p.width + 5);
                void 0 !== g &&
                (c = d.text(a.container, g, c, a.fontFamily, e, "start"), d.setCN(a, c, "zoom-out-label"), e =
                    c.getBBox(), q = p ? p.height / 2 - 3 : e.height / 2, c.translate(m,
                    q), b.push(c));
                p = b.getBBox();
                c = 1;
                d.isModern || (c = 0);
                ...
                b.hide();
                b.mouseover(function() { a.rollOverZB() }).mouseout(function() { a.rollOutZB() })
                    .click(function() { a.clickZB() }).touchstart(function() { a.rollOverZB() }).touchend(function() {
                        a.rollOutZB();
                        a.clickZB()
                    });
        ...
        drawPlotArea: function() {
            ...
            0 !== a &&
                0 !== b &&
                (g = this.plotAreaFillColors, "object" == typeof g && (g = g[0]), g = d.adjustLuminosity(g, -.15), h =
                    d.polygon(this.container, [0, a, h + a, h, 0], [0, b, b, 0, 0], g, k, 1, l, m), d.setCN(this,
                    h,
                    "plot-area-bottom"), h.translate(c,
                    e + f), this.set.push(h), a =
                    d.polygon(this.container, [0, 0, a, a, 0], [0, f, f + b, b, 0], g, k, 1, l, m), d.setCN(this,
                    a,
                    "plot-area-left"), a.translate(c, e), this.set.push(a));
        ...
        updateChartCursor: function() {
            var a = this.chartCursor;
            a &&
            (a = d.processObject(a, d.ChartCursor, this.theme), this.addChartCursor(a), a.x =
                this.marginLeftReal, a.y = this.marginTopReal, a.width = this.plotAreaWidth - 1, a.height =
                this.plotAreaHeight - 1, a.chart = this)
        },
        ...
        addChartCursor: function(a) {
            ...
            (this.listenTo(a,
                "changed",
                this.handleCursorChange), this.listenTo(a, "zoomed", this.handleCursorZoom));
            this.chartCursor = a
        },
        ...
        zoomTrendLines: function() {
            ...
            for (b = 0; b < a.length; b++) {
                ...
                c.valueAxis.recalculateToPercents
                    ? c.set && c.set.hide()
                    : (c.x = this.marginLeftReal + this.horizontalPosition, c.y =
                        this.marginTopReal + this.verticalPosition, c.draw())
            }
        },
        ...
        adjustMargins: function(a, b) {
            ...
            ("top" == c
                ? b
                ? this.marginLeftReal += e
                : this.marginTopReal += e
                : b
                ? this.marginRightReal += e
                : this.marginBottomReal += e)
        },
        ...
        updateChartScrollbar: function(a, b) {
            if (a) {
                ...
                "top" == a.position
                    ...
                    : (a.y = c - d + g - k, a.x = e + f)
                    : b
                    ? (a.y = c + g, a.x = e + this.plotAreaWidth + f + k)
    ...
    d.TrendLine = d.Class({
        ...
        draw: function() {
            ...
            var b = a.chart,
                ...
                v = b.dataDateFormat;
            k &&
            (l && (l = d.getDate(l, v, "fff"), a.initialDate = l, e = k.dateToCoordinate(l)),
                m && (e = k.categoryToCoordinate(m)), n &&
                    (n = d.getDate(n, v, "fff"), a.finalDate = n, h = k.dateToCoordinate(n)), p &&
                    (h = k.categoryToCoordinate(p)));
            ...
            if (!(isNaN(e) || isNaN(h) || isNaN(f) || isNaN(f))) {
                ...
                a.set = c;
                if (f = a.initialImage)
                    f = d.processObject(f, d.Image, a.theme), f.chart =
                        b, f.draw(), f.translate(e[0] + f.offsetX, h[0] + f.offsetY), c.push(f.set);
                if (f = a.finalImage)
                    f = d.processObject(f, d.Image, a.theme), f.chart =
                        b, f.draw(), f.translate(e[1] + f.offsetX, h[1] + f.offsetY), c.push(f.set);
                k.mouseup(function() { a.handleLineClick() }).mouseover(function() { a.handleLineOver() })
                    .mouseout(function() { a.handleLineOut() });
                k.touchend && k.touchend(function() { a.handleLineClick() });
                c.clipRect(0,
                    0,
                    b.plotAreaWidth,
                    b.plotAreaHeight)
...
(function() {
    ...
    d.Image = d.Class({
        ...
        draw: function() {
            ...
            var c, e;
            a.url
                ? (c = b.image(a.url, 0, 0, a.width, a.height), e = 1)
                : a.svgPath &&
                (c = b.path(a.svgPath), c.setAttr("fill", a.color), c.setAttr("stroke", a.outlineColor), b =
                    c.getBBox(), e =
                    Math.min(a.width / b.width, a.height / b.height));
            c &&
            (c.setAttr("opacity", a.opacity), a.set.rotate(a.rotation), c.translate(-a.width / 2, -a.height / 2, e),
                a.balloonText &&
                    c.mouseover(function(b) { a.chart.showBalloon(a.balloonText, a.balloonColor, !0) })
                    .mouseout(function(b) { a.chart.hideBalloon() }).touchend(function(b) { a.chart.hideBalloon() })
                    .touchstart(function(b) { a.chart.showBalloon(a.balloonText, a.balloonColor, !0) }), a.set.push(c))
        },
...
(function() {
    ...
    d.bullet = function(a, b, c, e, h, f, g, k, l, m, n, p) {
        ...
        case "yError":
            ...
            break;
        case "xError":
            q = a.set(), q.push(d.line(a, [-c / 2, c / 2], [0, 0], e, h, f)), q.push(d.line(a,
                [-c / 2, -c / 2],
                [-l, l],
                e,
                h,
                f)), q.push(d.line(a, [c / 2, c / 2], [-l, l], e, h, f))
        }
        q && q.pattern(n, NaN, p);
        return q
    };
    ...
    d.handDrawnLine = function(a, b, c, e, h, f, g, k, l, m) {
        ...
        for (n = 1; n < b.length; n++)
            for (var q = [b[n - 1], b[n]],
                r = [c[n - 1], c[n]],
                r = d.makeHD(q, r, a.handDrawScatter),
                q = r[0],
                r = r[1],
                t = 1;
                t < q.length;
    ...
    d.wedge = function(a, b, c, e, h, f, g, k, l, m, n, p, q) {
        ...
        var A = 1 / 180 * Math.PI,
            ...
            L = { fill: d.adjustLuminosity(m.fill, -.2), "stroke-opacity": 0, "fill-opacity": m["fill-opacity"] },
            H = 0;
        180 < Math.abs(h) && (H = 1);
        e = a.set();
        var J;
        u &&
        (x = r(10 * x), v = r(10 * v), B = r(10 * B), C = r(10 * C), w = r(10 * w), z = r(10 * z), D = r(10 * D), A =
            r(10 * A), b = r(10 * b), l = r(10 * l), c =
            r(10 * c), f *= 10, g *= 10, k *= 10, t *= 10, 1 > Math.abs(h) &&
            1 >=
            Math.abs(B -
                v) &&
            1 >= Math.abs(D - z) &&
        ...
        if (0 < l) {
            ...
            u
                ...
                (I += " B" +
                    ...
                    "," +
                    (l + w))))
                : (I += " A" + f + "," + g + ",0," + H + ",1," + B + "," + (D + l) + " L" + C + "," + (A + l), 0 < k &&
                    (I += " A" + k + "," + t + ",0," + H + ",0," + x + "," + (w + l)));
            I += " Z";
            var W = l;
            u &&
    ...
    d.adjustLuminosity = function(a, b) {
        ...
        var c = "#", e, h;
        for (h = 0; 3 > h; h++)
            e = parseInt(a.substr(2 * h, 2), 16), e =
                Math.round(Math.min(Math.max(0, e + e * b), 255)).toString(16), c += ("00" + e).substr(e.length);
        return c
    }
})();
(function() {
...
(function() {
    ...
    d.AmDraw = d.Class({
        construct: function(a, b, c, e) {
            ...
            d.hasSVG
                ? (d.SVG = !0, b = this.createSvgElement("svg"), a.appendChild(b), this.container =
                    b, this.addDefs(e), this.R = new d.SVGRenderer(this))
                : d.isIE &&
                d.VMLRenderer &&
                (d.VML = !0, d.vmlStyleSheet ||
                (document.namespaces.add("amvml", "urn:schemas-microsoft-com:vml"), 31 > document.styleSheets.length
                    ? (b = document.createStyleSheet(), b.addRule(".amvml",
                        "behavior:url(#default#VML); display:inline-block; antialias:true"), d.vmlStyleSheet = b)
                    : document.styleSheets[0].addRule(".amvml",
                        "behavior:url(#default#VML); display:inline-block; antialias:true")), this.container =
                    a, this.R = new d.VMLRenderer(this, e), this.R.disableSelection(a))
        },
        ...
        rect: function(a, b, c, e, h, f, g) {
            ...
            d.VML &&
            (h = Math.round(100 * h / Math.min(c, e)), c += 2 * f, e += 2 * f, k.bw = f, k.node.style.marginLeft =
    ...
    d.VMLRenderer = d.Class({
        ...
        setAttr: function(a, b, c) {
            if (void 0 !== c) {
                ...
                "text" == f &&
                ("text-anchor" == b &&
                    (a.anchor = c, k = h.clientWidth, "end" == c && (g.marginLeft = -k + "px"), "middle" == c &&
                    (g.marginLeft = -(k / 2) +
                        "px", g.textAlign = "center"), "start" == c && (g.marginLeft = "0px")),
                    "fill" == b && (g.color = c), "font-weight" == b && (g.fontWeight = c));
                ...
                if ("shape" == f) {
                    ...
                    "stroke-dasharray" == b &&
                    (g = "solid", 0 < c && 3 > c && (g = "dot"), 3 <= c && 6 >= c && (g = "dash"),
                        6 < c && (g = "longdash"), e ? f.dashstyle = g : f.setAttribute("dashstyle", g));
    ...
    d.SVGRenderer = d.Class({
        ...
        animate: function(a, b, c, e, h) {
            ...
            "translate" == b
                ? (f = (f = f.getAttribute("transform")) ? String(f).substring(10, f.length - 1) : "0,0",
                    f = f.split(", ").join(" "), f = f.split(" ").join(","), 0 === f && (f = "0,0"))
        ...
        update: function() {
            ...
            for (a = b.length - 1; 0 <= a; a--) {
                ...
                h <= e
                    ? (c.frame++, "translate" == g
                            ? (k = c.from.split(","), g = Number(k[0]), k = Number(k[1]), isNaN(k) && (k = 0), l =
                                c.to.split(","), m = Number(l[0]), l = Number(l[1]), m = 0 === m - g
                                ? m
                                : Math.round(d[c.effect](0,
                                    h,
                                    g,
                                    m - g,
                                    e)), c = 0 === l - k ? l : Math.round(d[c.effect](0, h, k, l - k, e)), g =
                                "transform", c = "translate(" + m + "," + c + ")")
                            : (l = Number(c.from), k = Number(c.to), m = k - l, c =
                                d[c.effect](0, h, l, m, e), isNaN(c) && (c = k), 0 === m && this.animations.splice(a, 1)
                            ),
                        this.setAttr(f, g, c))
                    : ("translate" == g
                        ? (l = c.to.split(","), m = Number(l[0]), l = Number(l[1]), f.translate(m, l))
                        : (k = Number(c.to), this.setAttr(f, g, k)), this.animations.splice(a, 1))
            }
        },
        getBBox: function(a) {
            if (a = a.node)
        ...
        clipRect: function(a, b, c, e, h) {
            ...
            var k = f.parentNode;
            k &&
            (f = document.createElementNS(d.SVG_NS, "clipPath"), g =
                d.getUniqueId(), f.setAttribute("id", g), this.D.rect(b, c, e, h, 0, 0, f), k.appendChild(f), b =
                "#", d.baseHref && !d.isIE && (b = this.removeTarget(window.location.href) + b), this.setAttr(a,
                "clip-path",
                "url(" + b + g + ")"), this.clipPathC++, a.clipPath = f)
        },
        text: function(a, b, c) {
        ...
        gradient: function(a, b, c, e) {
            ...
            for (e = 0; e < c.length; e++)
                g = document.createElementNS(d.SVG_NS, "stop"), k =
                    100 * e / (c.length - 1), 0 === e && (k = 0), g.setAttribute("offset", k + "%"), g.setAttribute(
                    "stop-color",
                    c[e]), b.appendChild(g);
        ...
        pattern: function(a, b, c, e) {
            ...
            b.color &&
            (n = document.createElementNS(d.SVG_NS, "rect"), n.setAttributeNS(null, "height", e),
...
AmCharts.AmDSet = AmCharts.Class({
    construct: function(d) { this.create("g") },
    attr: function(d) { this.R.attr(this.node, d) },
    move: function(d, a) { this.R.move(this.node, d, a) }
});
(function() {
    var d = window.AmCharts;
    d.AmLegend = d.Class({
        construct: function(a) {
            this.enabled = !0;
            this.cname = "AmLegend";
            this.createEvents("rollOverMarker",
                "rollOverItem",
                "rollOutMarker",
                "rollOutItem",
                "showItem",
        ...
        drawLegend: function() {
            ...
            "outside" == b
                ...
                : (isNaN(c) || (f.style.width = c + "px"), f.className =
                    "amChartsLegend " + a.classNamePrefix + "-legend-div");
            this.divWidth = c;
            (b = this.container)
                ? (b.container.innerHTML = "", f.appendChild(b.container), b.width = c, b.height =
                    h, b.setSize(c, h), b.addDefs(a))
            ...
            this.titleWidth = 0;
            if (h = this.title)
                h = d.text(this.container, h, this.color, a.fontFamily, this.fontSize, "start", !0), d.setCN(a,
                    h,
                    "legend-title"), h.translate(this.marginLeft, this.marginTop + this.verticalGap + this.ly + 1), a =
                    h.getBBox(), this.titleWidth = a.width + 15, this.titleHeight = a.height + 6;
        ...
        arrangeEntries: function() {
            ...
            l = w.height + 2 * m - 1;
            "left" == a || "right" == a
                ? (n = w.width + 2 * f, k = n + b + c, g.style.width = k + "px", this.ieW = k)
                : n = k - b - c - 1;
            ...
            if (!1 !== a.visibleInLegend) {
                ...
                if (this.useGraphSettings) {
                    ...
                    if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c)
                        g = l.set(), a.hidden || (e = a.lineColorR, f = a.bulletBorderColorR), n =
                                d.line(l, [0, 2 * m], [m / 2, m / 2], e, a.lineAlpha, a.lineThickness, a.dashLength),
                            d.setCN(b, n, "graph-stroke"), g.push(n), a.bullet &&
                                (a.hidden || (e = a.bulletColorR),
                                    n = d.bullet(l,
                                        ...
                                        f,
                                        a.bulletBorderAlpha)) &&
                                (d.setCN(b, n, "graph-bullet"), n.translate(m + 1, m / 2), g.push(n)), q = 0, n = m, p =
                                m / 3;
                    else {
                        var r;
                        ...
                        !0 === a.hidden && (n = e);
                        if (g =
                            this.createMarker("rectangle", n, a.fillAlphas, a.lineThickness, e, a.lineAlpha, r, g))
                            q = m, g.translate(q, m / 2);
                        n = m
                    }
                    d.setCN(b, g, "graph-" + c);
                ...
                (f = this.switchType) &&
                    "none" != f &&
                    0 < m &&
                    ("x" == f ? (r = this.createX(), r.translate(m / 2, m / 2)) : r = this.createV(), r.dItem =
                            a, !0 !== a.hidden ? "x" == f ? r.hide() : r.show() : "x" != f && r.hide(),
                        this.switchable ||
                            r.hide(),
                ...
                r = this.fontSize;
                g &&
                (m <= r && g.translate(q, m / 2 + this.ly - r / 2 + (r + 2 - m) / 2 - p), a.legendEntryWidth =
                    g.getBBox().width);
                var u;
                e &&
                (e = d.fixBrakes(e), a.legendTextReal = e, u = this.labelWidth, u = isNaN(u)
                        ? d.text(this.container,
                            e,
                            f,
                            b.fontFamily,
                            r,
                            "start")
                        : d.wrappedText(this.container, e, f, b.fontFamily, r, "start", !1, u, 0),
                    d.setCN(b, u, "legend-label"), u.translate(this.lx + n, this.ly), l.push(u), b =
                        u.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b));
        ...
        addListeners: function(a, b) {
            var c = this;
            a &&
                a.mouseover(function(a) { c.rollOverMarker(b, a) }).mouseout(function(a) { c.rollOutMarker(b, a) })
        ...
        rollOverLabel: function(a, b) {
            a.hidden ||
            (this.textClickEnabled && a.legendLabel && a.legendLabel.attr({ fill: this.rollOverColor }), this.dispatch(
                "rollOverItem",
                a,
                b))
        },
        ...
        clickLabel: function(a, b) {
            this.textClickEnabled
                ...
                : this.switchable &&
                (!0 === a.hidden ? this.dispatch("showItem", a, b) : this.dispatch("hideItem", a, b))
        },
        dispatch: function(a,
            b,
            c) {
        ...
        createValue: function(a) {
            ...
            if (!1 !== a.visibleInLegend) {
                ...
                b.entries[b.index -
                    1].push(c);
                c.mouseover(function(c) { b.rollOverLabel(a, c) }).mouseout(function(c) { b.rollOutLabel(a, c) })
            ...
            for (c = 0; c < a.length; c++) {
                ...
                if (e) f.value ? h.text(f.value) : h.text("");
                    ...
                    if (void 0 !== f.type) {
                        ...
                        k
                            ? (g = this.valueText, f.legendValueText && (g = f.legendValueText), g =
                                b.formatString(g, k))
                            : l &&
                            b.formatPeriodString &&
                            (l = d.massReplace(l, { "[[title]]": f.title }), g = b.formatPeriodString(l, f))
...
(function() {
    ...
    d.resetDateToMin = function(a, b, c, e) {
        ...
        var h, f, g, k, l, m, n;
        d.useUTC
            ? (h = a.getUTCFullYear(), f = a.getUTCMonth(), g = a.getUTCDate(), k = a.getUTCHours(), l =
                a.getUTCMinutes(), m = a.getUTCSeconds(), n = a.getUTCMilliseconds(), a = a.getUTCDay())
            : (h = a.getFullYear(), f = a.getMonth(), g = a.getDate(), k = a.getHours(), l = a.getMinutes(), m =
                a.getSeconds(), n = a.getMilliseconds(), a = a.getDay());
        switch (b) {
        case "YYYY":
            h =
                Math.floor(h / c) * c;
        ...
        d.useUTC
            ? (a = new Date, a.setUTCFullYear(h, f, g), a.setUTCHours(k, l, m, n))
            : a = new Date(h, f, g, k, l, m, n);
        return a
    };
    ...
    d.getMaxInterval = function(a, b) {
        ...
        return a >= c[b].contains
            ? (a = Math.round(a / c[b].contains),
                b = c[b].nextInterval, d.getMaxInterval(a, b))
            : "ss" == b
            ? c[b].nextInterval
            : b
    };
    ...
    d.stringToDate = function(a, b) {
        var c = {},
            e = [
                { pattern: "YYYY", period: "year" }, { pattern: "YY", period: "year" },
        ...
        d.useUTC
            ? (e =
                new Date, e.setUTCFullYear(c.year, c.month, c.date), e.setUTCHours(c.hours,
                c.minutes,
                c.seconds,
                c.milliseconds))
    ...
    d.getFromDateString = function(a, b, c) {
        if (void 0 !== b)
            return c = c.indexOf(a), b = String(b), b =
                b.substr(c, a.length), "0" == b.charAt(0) && (b = b.substr(1, b.length - 1)), b =
                Number(b), isNaN(b) && (b = 0), -1 != a.indexOf("M") && b--, b
    };
    d.formatDate =
        function(a, b, c) {
            c || (c = d);
            ...
            d.useUTC
                ? (e = a.getUTCFullYear(), h = a.getUTCMonth(), f = a.getUTCDate(), g = a.getUTCDay(), k =
                    a.getUTCHours(), l = a.getUTCMinutes(), m = a.getUTCSeconds(), a = a.getUTCMilliseconds())
                : (e = a.getFullYear(), h = a.getMonth(), f = a.getDate(), g = a.getDay(), k = a.getHours(), l =
                    a.getMinutes(), m = a.getSeconds(), a = a.getMilliseconds());
