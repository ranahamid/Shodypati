(function() {
    ...
    l.AmPieChart = l.Class({
        ...
        drawChart: function() {
            ...
            if (l.ifArray(d)) {
                if (0 < this.realWidth && 0 < this.realHeight) {
                    ...
                    var g = this.startDuration, c = this.container, b = this.updateWidth();
                    this.realWidth = b;
                    ...
                    k = e(this.radius, b, n);
                    k ||
                    (b = 0 <= y ? b - f - a - 2 * p : b - f - a, n = n - v - m, k =
                        Math.min(b, n), n < b && (k /= 1 - this.angle / 90, k > b && (k = b)), n =
                        l.toCoordinate(this.pullOutRadius, k), k = (0 <= y ? k - 1.8 * (y + n) : k - 1.8 * n) / 2);
                    ...
                    360 < m && (m -= 360);
                    b = k - k * this.angle / 90;
                    for (f = p = 0; f < d.length; f++)
                        a = d[f], !0 !== a.hidden && (p += l.roundTo(a.percents, this.pf.precision));
                            ...
                            if (this.labelsEnabled && this.labelText && a.percents >= this.hideLabelsPercent) {
                                ...
                                if (0 <= r) {
                                    ...
                                    90 >= h && 0 <= h
                                        ...
                                        ? (z = 3, x = "end", u = -8)
                                        : 357 <= h &&
                                        (f > D ? (z = 0, x = "start", u = 8) : (z = 3, x = "end", u = -8));
                                    a.labelQuarter = z
                                } else x = "middle";
        ...
        setDepths: function() {
            var d = this.chartData, g;
            for (g = 0; g < d.length; g++) {
                var c = d[g], b = c.wedge, c = c.startAngle;
                0 <= c && 180 > c ? b.toFront() : 180 <= c && b.toBack()
            }
        },
        arrangeLabels: function() {
            var d = this.chartData, g = d.length, c, b;
            for (b = g - 1; 0 <= b; b--)
                c = d[b], 0 !== c.labelQuarter ||
                    c.hidden ||
                    this.checkOverlapping(b,
                        c,
                        0,
                        !0,
                        0);
        ...
        checkOverlapping: function(d, g, c, b, l) {
            var e, f, a = this.chartData, v = a.length, m = g.label;
            if (m) {
                if (!0 === b)
                    for (f = d + 1; f < v; f++)
                        a[f].labelQuarter == c && (e = this.checkOverlappingReal(g, a[f], c)) && (f = v);
                else
                    for (f = d - 1; 0 <= f; f--)
                        a[f].labelQuarter == c &&
                            (e =
                ...
                !0 === e &&
                    ...
                    isNaN(g.labelRadius) &&
                    (e = g.ty + 3 * g.iy, g.ty =
                            e, m.translate(g.textX, e), g.hitRect &&
                            (m = m.getBBox(), g.hitRect.translate(g.tx2, e + m.y)),
                        this.checkOverlapping(d, g, c, b, l + 1))
            }
        },
        checkOverlappingReal: function(d, g, c) {
            var b = !1, n = d.label, e = g.label;
            d.labelQuarter != c ||
                d.hidden ||
                g.hidden ||
                !e ||
                (n = n.getBBox(), c = {}, c.width = n.width, c.height = n.height, c.y = d.ty, c.x = d.tx, d =
                    e.getBBox(), e = {}, e.width = d.width, e.height = d.height, e.y = g.ty, e.x =
                    g.tx, l.hitTest(c, e) && (b = !0));
            return b
        }
    })
})();