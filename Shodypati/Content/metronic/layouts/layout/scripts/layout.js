...
var Layout = function() {
    ...
    var handleSidebarAndContentHeight = function() {
        ...
        if (body.hasClass("page-footer-fixed") === true && body.hasClass("page-sidebar-fixed") === false) {
            var available_height = App.getViewPort().height -
    ...
    var handleSidebarMenu = function() {
        ...
        $(".page-sidebar-menu").on("click",
            ...
            function(e) {
                ...
                if (App.getViewPort().width >= resBreakpointMd &&
                    that.parents(".page-sidebar-menu-hover-submenu").size() === 1) { // exit of hover sidebar menu
                    return;
                }
        ...
        if (App.isAngularJsApp()) {
            $(".page-sidebar-menu li > a").on("click",
                function(e) {
        ...
        $(".page-sidebar .sidebar-search").on("keypress",
            "input.form-control",
            function(e) {
                if (e.which == 13) {
        ...
        if ($(".sidebar-search").size() !== 0) {
            $(".sidebar-search .input-group").on("click",
                function(e) {
                    e.stopPropagation();
                });
    ...
    return {
        ...
        initContent: function() {
            ...
            App.addResizeHandler(
                handleSidebarAndContentHeight); // recalculate sidebar & content height on window resize
