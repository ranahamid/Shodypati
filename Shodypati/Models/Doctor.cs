...
namespace Shodypati.Models
{
    public class Doctor
    {
        ...
        [Display(Name = "Registration No")] public int? RegistrationNo { get; set; }

        [Display(Name = "Registration Type")] public string RegistrationType { get; set; }
        ...
        [Display(Name = "Year Of Experience")] public decimal? YearOfExperience { get; set; }

        public List<SelectListItem> AllWorkingSelectListItems { get; set; }

        [Display(Name = "Working Area")] public string SelectedDoctorWorkingTypeId { get; set; }


        [Display(Name = "Working Area")] public string WorkingTypeName { get; set; }
        ...
        [Display(Name = "Can Visit Days")] public List<SelectListItem> CanVisitDays { get; set; }
        ...
        [Display(Name = "Visit Fee")] public int? VisitFee { get; set; }

        [Display(Name = "Visiting Card")] public string VisitingCard { get; set; }
