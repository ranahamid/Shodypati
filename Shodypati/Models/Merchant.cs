...
namespace Shodypati.Models
{
    public class Merchant
    {
        ...
        [Display(Name = "ব্যবসায়ীর নাম")] public string Name_Bangla { get; set; }

        public string Logo { get; set; }

        [Display(Name = "Type Of Goods")] public string TypeOfGoods { get; set; }

        public string Notes { get; set; }

        [Display(Name = "Discount Available")] public bool? DiscountAvailable { get; set; }
